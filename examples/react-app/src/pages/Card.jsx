...
const Card = () => {
  return (
    <>
      ...
      <section>
        <h2>Card editoriali standard</h2>
      ...
      <section>
        <h2>Card editoriali featured</h2>
        <div className="container-xl">
          <div className="row">
            <div className="col-12 col-md-6 col-lg-6 mb-3 mb-md-4">
              <it-card full-height>
          ...
          <div className="row">
            ...
            <div className="col-12 col-md-6 col-lg-6 mb-3 mb-md-4">
              <it-card full-height>
                ...
                <it-button slot="actions" variant="secondary" outline={true}>
                  <span className="visually-hidden">Link correlati: </span>
      ...
      <section>
        <h2>Card per eventi inline</h2>
        <div className="container-xl">
          <div className="row">
            <div className="col-12 col-md-12 col-lg-12 col-xl-10 mb-3 mb-md-4">
              <it-card variant="inline">
                <a slot="title" href="#">Titolo evento</a>
                <span slot="subtitle">
                  <span className="visually-hidden">Data evento:</span> <time dateTime="08-19">19 agosto</time>,
      ...
      <section>
        <h2>Card per media (video, audio)</h2>
        <div className="container-xl">
          <div className="row">
            <div className="col-12 col-md-6 col-lg-6 mb-3 mb-md-4">
              <it-card full-height>
      ...
      <section>
        <h2>Card per media video inline</h2>
        <div className="container-xl">
          <div className="row">
            <div className="col-12 col-md-12 col-lg-12 col-xl-10 mb-3 mb-md-4">
              <it-card variant="inline">
      ...
      <section>
        <h2>Card per servizi e bandi</h2>
        <div className="container-xl">
          <div className="row">
            <div className="col-12 col-md-6 col-lg-6 mb-3 mb-md-4">
              <it-card full-height>
            ...
            <div className="col-12 col-md-6 col-lg-6 mb-3 mb-md-4">
              <it-card full-height>
                ...
                <span slot="footer" className="it-card-date text-warning">
                  ...
                  <time className="it-card-date text-warning" dateTime="2026-04-22"> 22 aprile 2026 </time>
                </span>
                <it-button slot="actions" variant="secondary" outline={true}>
                  <span className="visually-hidden">Link correlati: </span>
      ...
      <section>
        <h2>Card per documenti e allegati</h2>
        <div className="container-xl">
          <div className="row">
            <div className="col-12 col-md-6 col-lg-6 mb-3 mb-md-4">
              <it-card>
            ...
            <div className="col-12 col-md-6 col-lg-6 mb-3 mb-md-4">
              <it-card>
                ...
                <span slot="actions" className="me-2">Scarica come:</span>
                <a slot="actions" href="#" className="it-card-link">
                  ODT (300KB)
      ...
      <section>
        <h2>Card per profili personali</h2>
        <div className="container-xl">
          <div className="row">
            <div className="col-12 col-md-6 col-lg-6 mb-3 mb-md-4">
            ...
            <div className="col-12 col-md-6 col-lg-6 mb-3 mb-md-4">
              <it-card full-height variant="profile">
                ...
                <dl slot="body" className="it-card-description-list">
                  <div>
                    <dt>Area:</dt>
                    <dd><a className="it-card-link" href="#">Nome dell'area di appartenenza</a></dd>
                  </div>
                  <div>
                    <dt>Email:</dt>
                    <dd>me@mail.com</dd>
      ...
      <section>
        <h2>Card con liste di contenuti affini</h2>
        <div className="container-xl">
          <div className="row">
            <div className="col-12 col-md-6 col-lg-6 mb-3 mb-md-4">
              <it-card full-height ratio="21x9">
                ...
                <ul slot="body" className="list-group list-group-flush" aria-label="Contenuti in evidenza:">
                  <li className="list-group-item"><a href="#">Titolo notizia affine</a></li>
                  <li className="list-group-item"><a href="#">Titolo media affine</a></li>
                  <li className="list-group-item"><a href="#">Altro titolo scheda affine</a></li>
                  <li className="list-group-item"><a href="#">Pagina profilo affine</a></li>
                </ul>
              </it-card>
            </div>
            <div className="col-12 col-md-6 col-lg-6 mb-3 mb-md-4">
              <it-card full-height ratio="21x9">
                ...
                <ul slot="body" className="list-group list-group-flush" aria-label="Contenuti in evidenza:">
                  <li className="list-group-item"><a href="#">Gli artisti</a></li>
                  <li className="list-group-item"><a href="#">Il luogo</a></li>
                  <li className="list-group-item"><a href="#">Il programma dettagliato</a></li>
                </ul>
                <div slot="footer" style="flex-grow: 1">
                  <a className="it-card-link" href="#">Iscriviti per rimanere aggiornato</a>
                </div>
                <a slot="footer" href="#" target="_blank" className="it-card-link">
                  Apri la mappa
            ...
            <div className="col-12 col-md-6 col-lg-6 mb-3 mb-md-4">
              <it-card full-height>
                ...
                <span slot="text">Descrizione breve dell'argomento in poche righe non troncate.</span>
                <ul slot="body" className="list-group list-group-flush" aria-label="Contenuti in evidenza:">
                  <li className="list-group-item"><a href="#" className="it-card-link">Titolo notizia affine</a></li>
                  <li className="list-group-item"><a href="#" className="it-card-link">Titolo media affine</a></li>
                  <li className="list-group-item"><a href="#" className="it-card-link">Altro titolo scheda affine</a></li>
                  <li className="list-group-item"><a href="#" className="it-card-link">Pagina profilo affine</a></li>
                </ul>
              </it-card>
            </div>
          </div>
          ...
          <div className="row">
            ...
            <div className="col-12 col-md-6 col-lg-6 mb-3 mb-md-4">
              <it-card variant="banner">
                ...
                <it-icon slot="image" color="secondary" name="it-chart-line" size="xl"></it-icon>
                <span slot="subtitle">Sottotitolo</span>
                <it-button slot="footer" variant="primary" outline={true}>
      ...
      <section>
        ...
        <div className="container-xl">
          <div className="row">
            <div className="col-12 col-md-6 col-lg-4 mb-3 mb-md-4">
              <it-card>
                ...
                <time slot="footer" className="it-card-date" dateTime="2026-10-12"> 12 ottobre, 2026 </time>
              </it-card>
            </div>
            <div className="col-12 col-md-6 col-lg-4 mb-3 mb-md-4">
              <it-card shadow="md">
          ...
          <div className="row">
            <div className="col-12 col-md-6 col-lg-4 mb-3 mb-md-4">&nbsp;</div>
            <div className="col-12 col-md-6 col-lg-4 mb-3 mb-md-4">
      ...
      <section>
        <h2>Pulsanti a tutta larghezza su mobile</h2>
        <div className="container-xl">
      ...
      <section>
        <h2>Liste per gruppi numerosi di card</h2>
        <div className="container-xl">
      ...
      <section>
        <h2>Uso di classi dedicate (per piccoli gruppi)</h2>
        <div className="container-xl">
          <div className="it-card-group">
            <it-card>
              <a slot="title" href="#">Titolo della prima card</a>
              <span slot="text">
                Questo è un testo breve che riassume il contenuto della pagina di destinazione.
              </span>
              <time slot="footer" className="it-card-date" dateTime="2026-10-12"> 12 ottobre, 2026 </time>
            </it-card>
            <it-card>
      ...
      <section>
        <h2>Numero di colonne specifiche</h2>
        <div className="container-xl">
      ...
      <section>
        <h2>Centrate orizzontalmente</h2>
        <div className="container-xl">
      ...
      {/* Uso rispetto al contenitore (sperimentale) */}
      <section>
        <h2>Uso rispetto al contenitore (sperimentale)</h2>
        <div className="container-xl">
          <div className="it-card-group it-card-group-container-aware">
            <it-card>
              <a slot="title" href="#">Card con Container Queries</a>
              <span slot="text">
                Questa card si adatta alla dimensione del suo contenitore, non della viewport.
              </span>
              <time slot="footer" className="it-card-date" dateTime="2026-10-12"> 12 ottobre, 2026 </time>
            </it-card>
            <it-card>
      ...
      <section>
        <h2>Confronto in colonne diverse</h2>
        <div className="container-xl">
          <div className="row">
              ...
              <div className="p-3 bg-light">
                <div className="it-card-group it-card-group-container-aware">
                  <it-card>
                    ...
                    <span slot="text">
                      In questa colonna stretta, le card si dispongono su una singola colonna.
                    </span>
                  </it-card>
                  <it-card>
                    <a slot="title" href="#">Card in colonna stretta</a>
