...
const Input = () => {
  return (
    <>
        ...
        <div class="container">
          <div class="row">
            <div class="col-12 col-md-6">
              <p>
                <strong>Overlay ad altezza fissa</strong>
              </p>
            ...
            <div class="col-12 col-md-6">
              <p>
                <strong>Overlay a tutta altezza</strong>
              </p>
              <figure class="overlay-wrapper">
                <img src="https://picsum.photos/240/160?image=1056" alt="descrizione immagine" class="img-fluid" />
            ...
            <div class="col-12">
              <p>
                <strong>Esempio con differenti proporzioni</strong>
              </p>
              <figure class="overlay-wrapper">
      ...
      <section>
        <h2>Overlay con icona</h2>
        <div class="container">
          <div class="row">
            <div class="col-12 col-md-6">
              <p>
                <strong>Overlay primary (default)</strong>
              </p>
              <figure class="overlay-wrapper">
