    ...
    <>
        ...
        <it-timeline variant="point-list" as="ol">
          <it-timeline-point>
            <time slot="date" dateTime="2025-10-14">
              <span className="visually-hidden">14 ottobre 2025</span>
              <span className="point-visual">
                <span className="point-main font-monospace">14</span>
                <span className="point-bottom font-monospace">ott</span>
              </span>
            </time>
          ...
          <it-timeline-point>
            <time slot="date" dateTime="2025-12-14">
              <span className="visually-hidden">14 dicembre 2025</span>
              <span className="point-visual">
                <span className="point-main font-monospace">14</span>
                <span className="point-bottom font-monospace">dic</span>
              </span>
            </time>
            <p slot="content">Lorem ipsum dolor sit amet, consectetur adipiscing elit.</p>
          </it-timeline-point>
        ...
        <it-timeline variant="point-list">
          <it-timeline-point>
            <time slot="date" dateTime="2025-10-14">
              ...
              <span className="point-visual">
                <span className="point-main font-monospace">14</span>
                <span className="point-bottom font-monospace">ottobre</span>
              </span>
            </time>
            <p slot="content">Lorem ipsum dolor sit amet, consectetur adipiscing elit.</p>
          </it-timeline-point>
        ...
        <it-timeline variant="point-list">
          <it-timeline-point>
            <time slot="date" dateTime="2025-10-14">
              <span className="visually-hidden">14 ottobre 2025</span>
              <span className="point-visual">
                <span className="point-top font-monospace">2025</span>
                <span className="point-main font-monospace">14</span>
                <span className="point-bottom font-monospace">ottobre</span>
              </span>
            </time>
      ...
      <section>
        ...
        <it-timeline variant="point-list">
          <it-timeline-point>
            <div slot="milestone">
              <span className="visually-hidden">Passo 1</span>
              <span className="point-visual">
                <span className="point-main font-monospace">1</span>
              </span>
            </div>
            <p slot="content">Lorem ipsum dolor sit amet, consectetur adipiscing elit.</p>
          </it-timeline-point>
          <it-timeline-point>
            <div slot="milestone">
              <span className="visually-hidden">Passo 1 di 3</span>
              <span className="point-visual">
                <span className="point-main font-monospace">1</span>
                <span className="point-bottom font-monospace">/ 3</span>
              </span>
            </div>
            <p slot="content">Lorem ipsum dolor sit amet, consectetur adipiscing elit.</p>
          </it-timeline-point>
          <it-timeline-point>
            <div slot="milestone">
              <span className="visually-hidden">Categoria AB, passo 1 di 3</span>
              <span className="point-visual">
                <span className="point-top font-monospace">AB</span>
                <span className="point-main font-monospace">1</span>
                <span className="point-bottom font-monospace">/ 3</span>
              </span>
            </div>
      ...
      <section>
        ...
        <it-timeline variant="point-list">
          <it-timeline-point color="success">
            <div slot="milestone">
              <span className="visually-hidden">Milestone completata</span>
              <span className="point-visual">
                <span className="point-main font-monospace">
          ...
          <it-timeline-point color="primary">
            <div slot="milestone">
              <span className="visually-hidden">Documento rilasciato</span>
              <span className="point-visual">
                <span className="point-main font-monospace">
          ...
          <it-timeline-point color="warning">
            <div slot="milestone">
              <span className="visually-hidden">Versione 2, codice JavaScript</span>
              <span className="point-visual">
                <span className="point-top font-monospace">v2</span>
                <span className="point-main font-monospace">
                  <it-icon name="it-code-circle"></it-icon>
                </span>
                <span className="point-bottom font-monospace">JS</span>
              </span>
            </div>
            <p slot="content">Lorem ipsum dolor sit amet, consectetur adipiscing elit.</p>
          </it-timeline-point>
        ...
        <it-timeline variant="point-list" color="secondary">
          <it-timeline-point>
            <time slot="date" dateTime="2022-01-04">
              <span className="visually-hidden">4 gennaio 2022</span>
              <span className="point-visual" aria-hidden="true">
                <span className="point-top font-monospace">2022</span>
                <span className="point-main font-monospace">04</span>
                <span className="point-bottom font-monospace">GEN</span>
              </span>
            </time>
          ...
          <it-timeline-point>
            <time slot="date" dateTime="2022-02-04">
              <span className="visually-hidden">4 febbraio 2022</span>
              <span className="point-visual" aria-hidden="true">
                <span className="point-top font-monospace">2022</span>
                <span className="point-main font-monospace">04</span>
                <span className="point-bottom font-monospace">FEB</span>
              </span>
            </time>
            <it-card full-height border-top="secondary" slot="content">
          ...
          <it-timeline-point>
            <time slot="date" dateTime="2022-03-02">
              <span className="visually-hidden">2 marzo 2022</span>
              <span className="point-visual" aria-hidden="true">
                <span className="point-top font-monospace">2022</span>
                <span className="point-main font-monospace">02</span>
                <span className="point-bottom font-monospace">MAR</span>
              </span>
            </time>
            <it-card full-height border-top="secondary" slot="content">
          ...
          <it-timeline-point align-top>
            <time slot="date" dateTime="2022-04-02">
              <span className="visually-hidden">2 aprile 2022</span>
              <span className="point-visual" aria-hidden="true">
                <span className="point-top font-monospace">2022</span>
                <span className="point-main font-monospace">02</span>
                <span className="point-bottom font-monospace">APR</span>
              </span>
            </time>
            <it-card full-height border-top="secondary" slot="content">
              ...
              <div slot="body">
                ...
                terzo riga utile per ulteriori istruzioni relative a questa scadenza. Se diventa così lungo bene avere
                la data allineata al to.
              </div>
            </it-card>
          </it-timeline-point>
        </it-timeline>
        ...
        <it-timeline variant="point-list" stack-mobile>
          ...
          <it-timeline-point align-top color="danger">
            <time slot="date" dateTime="2025-10-31">
              <span className="visually-hidden">31 ottobre 2025</span>
              <span className="point-visual">
                <span className="point-main font-monospace">31</span>
                <span className="point-bottom font-monospace">ott</span>
              </span>
            </time>
