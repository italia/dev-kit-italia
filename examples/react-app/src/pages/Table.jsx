  ...
  return (
    <div className="container my-5">
      ...
      <section className="mb-5">
        ...
        <p>
          Evidenzia una riga o cella della tabella aggiungendo la classe <code>.table-active</code>.
        </p>
        <table className="table">
          <thead>
            <tr>
      ...
      <section className="mb-5">
        ...
        <p>
          Aggiungi la classe <code>.table-borderless</code> per una tabella senza bordi.
        </p>
      ...
      <section className="mb-5">
        ...
        <p>
          Aggiungi <code>.table-sm</code> per rendere le tabelle più compatte dimezzando il cell padding.
        </p>
      ...
      <section className="mb-5">
        ...
        <p>
          Le tabelle possono avere un footer utilizzando l'elemento <code>&lt;tfoot&gt;</code>.
        </p>
        <table className="table">
          <thead>
            <tr>
