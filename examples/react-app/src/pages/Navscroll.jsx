    ...
    <>
      ...
      <div class="row row-column-border border-light row-column-menu-left">
          ...
          <it-navscroll breakpoint="1024" open-label="Naviga fra le sezioni" sticky={true} for="#scroll-container">
            <div class="link-list-wrapper">
              ...
              <it-progress
                type="bar"
                value="0"
                class="it-navscroll-progressbar"
        ...
        <main id="scroll-container" class="col-lg-8 it-page-sections-container border-light">
          ...
          <h2 class="it-page-section" id="p1">
            Introduzione
          </h2>
          <p>
          ...
          <h3 class="it-page-section" id="p1_1">
          ...
          <h4 class="it-page-section" id="p1_1_1">
          ...
          <h4 class="it-page-section" id="p1_1_2">
          ...
          <h4 class="it-page-section" id="p1_1_3">
          ...
          <h3 class="it-page-section" id="p1_2">
          ...
          <h3 class="it-page-section" id="p1_3">
          ...
          <h2 class="it-page-section" id="p2">
            Seconda sezione
          </h2>
          <p>
            Proin placerat ipsum massa, ac commodo velit tempor quis. In ante augue,sodales ac rhoncus in, ultricies a
          ...
          <h3 class="it-page-section" id="p2_1">
          ...
          <h4 class="it-page-section" id="p2_1_1">
          ...
          <h4 class="it-page-section" id="p2_1_2">
          ...
          <h4 class="it-page-section" id="p2_1_3">
