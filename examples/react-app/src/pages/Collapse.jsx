...
const Collapse = () => {
  return (
    <>
      ...
      <p>Il componente Collapse permette di mostrare e nascondere contenuti con un'animazione fluida.</p>

      <section>
        <h2>Comportamento base</h2>
        <p>
          La proprietà <code>as</code> seleziona il tag del trigger di default.
        </p>
      ...
      <section>
        ...
        <p>
          Usa l'attributo <code>variant</code> per applicare le varianti Bootstrap Italia ai trigger di Collapse.
        </p>
      ...
      <section>
        ...
        <p>
          L'attributo <code>default-open</code> permette di avere il collapse aperto al primo rendering.
        </p>
      ...
      <section>
        ...
        <it-collapse as="a">
          ...
          <div
            slot="content"
            style={{ padding: '1.5rem 1rem', backgroundColor: '#fff', border: '1px solid black', borderRadius: '4px' }}
          >
            Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et
            dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex
            ea commodo consequat.
      ...
      <section>
        ...
        <p>
          È possibile utilizzare un trigger personalizzato inserendo un elemento nello slot <code>trigger</code>.
        </p>
