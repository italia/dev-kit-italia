      ...
      <section>
        ...
        <it-callout variant="success" highlight>
          ...
          <p>
            ...
            commodo odio mauris semper dolor. Maecenas vulputate ante dictum vestibulum volutpat. Lorem ipsum dolor sit
            amet, consectetur adipiscing elit. Aenean non augue non purus vestibulum varius. Maecenas ullamcorper
      ...
      <section>
        ...
        <it-callout callout-more>
          ...
          <it-callout-more slot="more-content">
            ...
            <a slot="extra" className="callout-more-download" href="#">
              <it-icon name="it-download" color="primary"></it-icon>
              <span className="visually-hidden">Scarica il contenuto in PDF </span>
              Download
            </a>
          </it-callout-more>
        </it-callout>
