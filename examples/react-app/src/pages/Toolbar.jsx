  ...
  return (
    <>
      ...
      <section>
        <h2>Toolbar media</h2>
        <p>
          Nella versione media (<code>size="md"</code>) le label vengono nascoste visivamente.
        </p>
        <div style={toolbarWrapperStyle}>
      ...
      <section>
        ...
        <p>
          La versione piccola (<code>size="sm"</code>) nasconde anch'essa le label visivamente.
        </p>
        <div style={toolbarWrapperStyle}>
      ...
      <section>
        ...
        <p>
          I badge indicano contenuti non letti o notifiche. Usa <code>label-extended</code> per una descrizione
        ...
        <div style={toolbarWrapperStyle}>
          <it-toolbar it-aria-label="Toolbar con dropdown">
            <it-toolbar-item dropdown active label="Messaggi" icon="it-comment" badge="1" label-extended="da leggere">
              <it-dropdown-item slot="items" href="#">
                Azione 1
              </it-dropdown-item>
              <it-dropdown-item slot="items" href="#">
                Azione 2
            ...
            <it-toolbar-item dropdown label="Altro" icon="it-more-actions" className="no-expand">
              <it-dropdown-item slot="items" href="#">
                Azione 1
              </it-dropdown-item>
              <it-dropdown-item slot="items" href="#">
      ...
      <section>
        ...
        <p>
          Applicando l'attributo <code>orientation="vertical"</code> gli elementi vengono visualizzati in colonna.
        </p>
        <div style={toolbarWrapperStyle}>
