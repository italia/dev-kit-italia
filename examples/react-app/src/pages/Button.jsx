  ...
  return (
    <>
      ...
      <section>
        ...
        <div className="flex p-0">
          <div className="flex">
            <it-button variant="secondary" size="sm" type="button">
              Secondary
            </it-button>
        ...
        <div className="flex p-0">
          <div className="flex">
            <it-button variant="success" size="sm" type="button">
              Success
            </it-button>
          ...
          <div className="flex">
            <it-button variant="success" outline={true} size="sm" type="button">
              Success outline
            </it-button>
        ...
        <div className="flex p-0">
          <div className="flex">
            <it-button variant="danger" size="sm" type="button">
              Danger
            </it-button>
          ...
          <div className="flex">
            <it-button variant="danger" outline={true} size="sm" type="button">
              Danger outline
            </it-button>
        ...
        <div className="flex p-0">
          <div className="flex">
            <it-button variant="warning" size="sm" type="button">
              Warning
            </it-button>
          ...
          <div className="flex">
            <it-button variant="warning" outline={true} size="sm" type="button">
              Warning outline
            </it-button>
        ...
        <div className="flex p-0">
          <div className="flex">
            <it-button variant="link" size="sm" type="button">
              Link
            </it-button>
      ...
      <section>
        ...
        <div className="flex">
          <it-button variant="primary" size="lg" type="button">
            Primary Large
          </it-button>

          <it-button variant="secondary" size="lg" type="button">
            Secondary Large
          </it-button>
        </div>
        <div className="flex">
        ...
        <div className="flex">
          <it-button variant="primary" size="xs" type="button">
            Primary Extra Small
          </it-button>

          <it-button variant="secondary" size="xs" type="button">
            Secondary Extra Small
          </it-button>
        </div>
        <div className="flex">
          <it-button variant="primary" size="sm" block={true} type="button">
            Primary Block
          </it-button>
        </div>
        <div className="flex">
          <it-button variant="secondary" size="sm" block={true} type="button">
            Secondary Block
          </it-button>
        </div>
      </section>
      <section>
        ...
        <div className="flex">
          ...
          <it-button variant="primary" size="sm" type="submit">
            Submit - Testo del pulsante
          </it-button>

          <it-button variant="primary" size="sm" type="reset">
            Reset - Testo del pulsante
          </it-button>
        </div>
      </section>
      <section>
