...
const componentsMenuItems = [
  ...
  { label: 'Carousel', href: 'src/carousel' },
  ...
  { label: 'Pagination', href: 'src/pagination' },
  { label: 'Popover', href: 'src/popover' },
  { label: 'Progress', href: 'src/progress' },
  { label: 'Radio', href: 'src/radio-examples' },
  { label: 'Rating', href: 'src/rating' },
  ...
  ...item,
  href: `${import.meta.env.BASE_URL}${item.href}.html`,
}));
