<script>
  const previewStyle =
    'transform:translateZ(0);overflow:hidden;position:relative;height:200px;width:100%;max-width:400px;background:#f5f5f5;border:1px solid #cecece;margin-bottom:2rem;';
  const previewContentStyle = 'height:calc(100% - var(--it-bottom-nav-height,64px));overflow-y:scroll;';
  const scrollAreaStyle = 'height:400px;padding:1rem;color:#666;font-size:0.875rem;';
</script>
...
<section>
  ...
  <p>
    ...
    l'accessibilità aggiungi uno <code>&lt;span class="visually-hidden"&gt;</code> con un testo descrittivo.
  </p>
  <div style={previewStyle}>
    <div style={previewContentStyle}>
      <div style={scrollAreaStyle}>Scorri per vedere la barra in basso.</div>
