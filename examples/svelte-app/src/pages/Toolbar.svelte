...
<section>
  ...
  <div
    style="position: relative; min-height: 500px; width: 80%; margin: auto; background-color: #ccc; border: 1px solid #ccc;"
  >
...
<section>
  ...
  <p>
    I badge indicano contenuti non letti o notifiche. Usa <code>label-extended</code> per una descrizione accessibile agli
    screen reader.
  </p>
  <div
    style="position: relative; min-height: 500px; width: 80%; margin: auto; background-color: #ccc; border: 1px solid #ccc;"
  >
    <it-toolbar it-aria-label="Toolbar con badge">
      <it-toolbar-item active label="Messaggi" icon="it-comment" href="#" badge="1" label-extended="da leggere"
      ></it-toolbar-item>
      <it-toolbar-item label="Documenti" icon="it-file" href="#" badge="42" label-extended="da esaminare"
      ></it-toolbar-item>
      <it-toolbar-item label="Immagini" icon="it-camera" href="#"></it-toolbar-item>
      <it-toolbar-item label="Privacy" icon="it-locked" href="#"></it-toolbar-item>
      <it-toolbar-item disabled label="Preferiti" icon="it-star-outline" href="#"></it-toolbar-item>
...
<section>
  ...
  >
    <it-toolbar orientation="vertical" it-aria-label="Toolbar verticale">
      <it-toolbar-item active label="Messaggi" icon="it-comment" badge="42" href="#" label-extended="da leggere"
      ></it-toolbar-item>
