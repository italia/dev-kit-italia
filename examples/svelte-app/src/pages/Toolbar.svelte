  ...
  <it-toolbar>
    <li>
      <a href="#" class="active">
        ...
        <span class="toolbar-label">
          messaggi <span class="visually-hidden">1 da leggere</span>
        </span>
    ...
    <li>
      <a href="#">
        ...
        <span class="toolbar-label">
          documenti <span class="visually-hidden">42 da esaminare</span>
        </span>
  ...
  <it-toolbar>
    ...
    <li>
      <a href="#" class="disabled" disabled>
        ...
        <span class="toolbar-label">immagini (disabilitato)</span>
      </a>
    </li>
    <li>
      <a href="#">
