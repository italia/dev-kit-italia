...
<div class="container my-5">
    ...
    <it-modal close-label="Chiudi finestra modale">
      ...
      <div slot="footer" class="d-flex justify-content-between gap-2 align-items-center" style="width:100%;">
        ...
        <div class="d-flex justify-content-end gap-2">
          <it-button variant="outline-primary" on:click={closeModal}>Annulla</it-button>
          <it-button slot="footer" variant="primary" on:click={closeModal}>Conferma</it-button>
        </div>
      </div>
    </it-modal>
  ...
  <section class="my-5">
    ...
    <it-modal variant="link-list" close-label="Chiudi finestra modale">
      <it-button variant="primary" slot="trigger">Lancia la demo della modale</it-button>
      <span slot="header">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt</span>
  ...
  <section class="my-5">
    ...
    <div class="d-flex gap-3">
      <it-modal variant="popconfirm">
        ...
        <it-button slot="footer" variant="outline-primary" on:click={closeModal}>Azione 1</it-button>
        <it-button slot="footer" variant="primary" on:click={closeModal}>Azione 2</it-button>
      </it-modal>
