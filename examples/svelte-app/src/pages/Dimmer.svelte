...
<h1>Dimmer</h1>
<p>
  Componente per focalizzare l'attenzione su un contenuto sovrapposto, oscurando il contenuto principale sottostante.
</p>
...
<section class="my-5">
  ...
  <div data-demo-wrapper>
    <div class="mb-3">
      <it-button variant="primary" on:click={toggle}>Toggle dimmer</it-button>
    </div>
...
<section class="my-5">
  ...
  <div data-demo-wrapper>
    <div class="mb-3 d-flex gap-2">
      <it-button variant="primary" on:click={show}>show()</it-button>
      <it-button variant="primary" outline on:click={hide}>hide()</it-button>
      <it-button variant="secondary" outline on:click={toggle}>toggle()</it-button>
    </div>
    <it-dimmer icon-name="it-info-circle">
