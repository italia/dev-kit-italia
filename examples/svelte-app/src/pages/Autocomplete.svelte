...
<div class="container my-4">
  ...
  <section class="example-section">
    ...
    <p>Label accessibile ma visivamente nascosta</p>
  ...
  <section class="example-section">
    ...
    <it-autocomplete name="citta" min-length="2" source={asyncSearchFunction}>
    ...
    <div class="row">
      <div class="col-12 col-md-6 mb-3">
        <div class="form-group">
          ...
          <select id="categoria-select" class="form-control" bind:value={selectedCategory}>
