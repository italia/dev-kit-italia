...
<section>
  <h2>Checked</h2>
  <it-checkbox id="checked" name="esempioChecked" checked>
...
<section>
  <h2>Indeterminate</h2>
  <it-checkbox id="indeterminate" indeterminate>
...
<section>
  <h2>Disabilitata</h2>
  <it-checkbox id="disabledd" disabled>
...
<section>
  <h2>Required</h2>
  <it-checkbox id="required" required>
...
<section>
  ...
  <fieldset>
    ...
    <it-checkbox id="inline-1" inline>
      <span slot="label">Checkbox di esempio inline 1</span>
    </it-checkbox>
    <it-checkbox id="inline-2" inline>
...
<section>
  ...
  <fieldset>
    <legend>Gruppo di checkbox</legend>
    <it-checkbox id="inline-1" group>
      <span slot="label">Checkbox di esempio inline 1</span>
    </it-checkbox>
    <it-checkbox id="inline-2" group>
      <span slot="label">Checkbox di esempio inline 2</span>
    </it-checkbox>
  </fieldset>
</section>
...
<section>
  ...
  <it-checkbox id="customvalidation" supportText="Testo di supporto" custom-validation validity-message="Obbligatorio!">
    <span slot="label">Checkbox di esempio</span>
  </it-checkbox>
</section>
