  ...
  <it-timeline variant="point-list" color="secondary">
    ...
    <it-timeline-point align-top>
      ...
      <it-card full-height border-top="secondary" slot="content">
        ...
        <div slot="body">
          Termine ultimo per la conferma dell'iscrizione e il pagamento della quota. Fino al secondo o anche
          anche terzo riga utile per ulteriori istruzioni relative a questa scadenza. Se diventa così lungo bene
          avere la data allineata al to.
        </div>
      </it-card>
    </it-timeline-point>
  </it-timeline>
