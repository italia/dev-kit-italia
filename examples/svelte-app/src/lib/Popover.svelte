    ...
    <div slot="content" class="popover" tabindex="-1">
      <div class="popover-inner">
        ...
        <div class="popover-body">
          Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nunc vel finibus augue. Vestibulum ante ipsum primis
...
<section>
  ...
  <div style="display: flex; flex-direction: column; gap: 1rem; align-items: flex-start">
    <div style="display: flex; gap: 0.5rem">
      <it-button variant="secondary" size="sm" on:click={openPopover}>Apri</it-button>
      <it-button variant="secondary" size="sm" on:click={closePopover}>Chiudi</it-button>
      <it-button variant="secondary" size="sm" on:click={togglePopover}>Toggle</it-button>
    </div>

    <it-popover bind:this={popoverRef} placement="bottom">
...
<section>
  ...
  <it-popover placement="bottom" on:it-popover-open={handlePopoverOpen} on:it-popover-close={handlePopoverClose}>
