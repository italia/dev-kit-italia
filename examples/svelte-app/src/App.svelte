...
<main>
  <div class="app-header">
    <!-- Svelte: traduzione 1:1 del template React, markup, slot, layout, gruppi, status, presenza, extra-text, dropdown, accessibilità -->
    <script>
    ...
    <div>
      <section>
        ...
        <div style="display: flex; gap: 1rem; align-items: center; justify-content: center; flex-wrap: wrap;">
          {#each ['xs', 'sm', 'md', 'lg', 'xl', 'xxl'] as size}
            <it-avatar type="image" src="https://randomuser.me/api/portraits/women/44.jpg" alt="Luisa Neri" size={size}></it-avatar>
          {/each}
        </div>
      </section>
      <section>
        <h2>Avatar con testo</h2>
        <div style="display: flex; gap: 1rem; align-items: center; justify-content: center; flex-wrap: wrap; margin-bottom: 16px;">
          {#each ['xs', 'sm', 'md', 'lg', 'xl', 'xxl'] as size}
            <it-avatar type="text" text="Mario Rossi" size={size}></it-avatar>
          {/each}
        </div>
        <div style="display: flex; gap: 1rem; align-items: center; justify-content: center; flex-wrap: wrap; margin-bottom: 16px;">
          {#each ['xs', 'sm', 'md', 'lg', 'xl', 'xxl'] as size}
            <it-avatar type="text" text="Mario Rossi" variant="primary" size={size}></it-avatar>
          {/each}
        </div>
        <div style="display: flex; gap: 1rem; align-items: center; justify-content: center; flex-wrap: wrap;">
          {#each ['xs', 'sm', 'md', 'lg', 'xl', 'xxl'] as size}
            <it-avatar type="text" text="Mario Rossi" variant="secondary" size={size}></it-avatar>
          {/each}
        </div>
      </section>
      <section>
        ...
        <div style="display: flex; gap: 1rem; align-items: center; justify-content: center; flex-wrap: wrap;">
          {#each ['xs', 'sm', 'md', 'lg', 'xl', 'xxl'] as size}
            <it-avatar type="icon" icon="it-search" avatar-title="Cerca" size={size}></it-avatar>
          {/each}
        </div>
      </section>
      <section>
        ...
        <div style="display: flex; gap: 2rem; flex-wrap: wrap; align-items: center; justify-content: center;">
          <div style="text-align: center;">
            <it-avatar type="text" text="Marco Bianchi" variant="primary" presence="active" size="lg">
              <span
                slot="presence"
                style="position: absolute; bottom: 0; right: 0; background: #28a745; variant: white; border-radius: 50%; width: 20px; height: 20px; display: flex; align-items: center; justify-content: center; border: 2px solid white;"
              >
          ...
          <div style="text-align: center; align-items: center; justify-content: center; display: flex;">
            <it-avatar type="text" text="Sara Verdi" variant="secondary" presence="busy" size="lg">
              <span
                slot="presence"
                style="position: absolute; bottom: 0; right: 0; background: #dc3545; variant: white; border-radius: 50%; width: 20px; height: 20px; display: flex; align-items: center; justify-content: center; border: 2px solid white; font-size: 10px; font-weight: bold;"
              >
          ...
          <div style="text-align: center; display: flex; align-items: center; justify-content: center;">
            <it-avatar src="https://randomuser.me/api/portraits/women/32.jpg" alt="Foto profilo" presence="hidden" size="lg">
              <span
                slot="presence"
                style="position: absolute; bottom: 0; right: 0; background: #6c757d; opacity: 0.7; border-radius: 50%; width: 20px; height: 20px; display: flex; align-items: center; justify-content: center; border: 2px solid white;"
              >
        ...
        <div style="display: flex; gap: 2rem; flex-wrap: wrap; align-items: center; justify-content: center;">
          <div style="text-align: center;">
            <it-avatar type="text" text="Luigi Neri" variant="primary" status="approved" size="lg">
              <span
                slot="status"
                style="position: absolute; top: -5px; right: -5px; background: #28a745; variant: white; border-radius: 50%; width: 24px; height: 24px; display: flex; align-items: center; justify-content: center; border: 2px solid white;"
              >
          ...
          <div style="text-align: center; align-items: center; justify-content: center; display: flex;">
            <it-avatar type="text" text="Carla Blu" variant="secondary" status="declined" size="lg">
              <span
                slot="status"
                style="position: absolute; top: -5px; right: -5px; background: #dc3545; variant: white; border-radius: 50%; width: 24px; height: 24px; display: flex; align-items: center; justify-content: center; border: 2px solid white;"
              >
          ...
          <div style="text-align: center; align-items: center; justify-content: center; display: flex;">
            <it-avatar src="https://randomuser.me/api/portraits/men/25.jpg" alt="Foto profilo" status="notify" size="lg">
              <span
                slot="status"
                style="position: absolute; top: -5px; right: -5px; background: #17a2b8; border-radius: 50%; width: 24px; height: 24px; display: flex; align-items: center; justify-content: center; border: 2px solid white; padding: 2px;"
              >
      ...
      <!-- Gruppi avatar, sovrapposti, dropdown, ecc. possono essere aggiunti qui seguendo la stessa struttura React -->
