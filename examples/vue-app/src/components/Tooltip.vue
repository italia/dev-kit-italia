<template>
  ...
  <section style="margin-bottom: 2rem">
    ...
    <p style="max-width: 400px; line-height: 2">
      ...
      <it-tooltip placement="top">
        <a slot="trigger" href="#" @click="handleLinkClick">link in una frase</a>
      ...
      <it-tooltip placement="top">
        <a slot="trigger" href="#" @click="handleLinkClick">elemento con tooltip</a>
  ...
  <section style="margin-bottom: 2rem">
    <h2>Posizione</h2>
    <div style="display: grid; gap: .5rem; grid-template: 1fr 1fr 1fr / 1fr 1fr 1fr; place-items: center">
  ...
  <section style="margin-bottom: 2rem">
    ...
    <div style="display: flex; gap: 1rem; align-items: flex-start; height: 70px">
      <it-tooltip placement="bottom" controlled ref="tooltipControlled">
  ...
  <section style="margin-bottom: 2rem">
    ...
    <it-tooltip
      placement="right"
      @it-tooltip-open="handleTooltipOpen"
      @it-tooltip-close="handleTooltipClose"
    >
...
export default {
  ...
  methods: {
    ...
    handleShowTooltip() {
      this.$refs.tooltipControlled?.showTooltip();
    },
    handleHideTooltip() {
      this.$refs.tooltipControlled?.hideTooltip();
    },
    handleTooltipOpen(e) {
