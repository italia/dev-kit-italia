<template>
  <div class="container my-4" @keydown="handleTabKey">
    ...
    <section>
      <h2>Header attivi</h2>
      <p>
        Aggiungere la proprietà <code>background-active</code> per ottenere header con sfondo di colore primario quando
        questi sono attivi e il contenuto relativo è visibile.
      </p>
    ...
    <section>
      ...
      <p>
        Quando l'attributo <code>left-icon</code> è abilitato, le icone plus/minus vengono mostrate a sinistra del testo
        invece della freccia a destra. Questa variante è specifica per Bootstrap Italia.
      </p>
