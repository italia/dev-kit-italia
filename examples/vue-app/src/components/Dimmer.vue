...
<template>
  ...
  <section class="my-5">
    ...
    <div data-demo-wrapper>
      <div class="mb-3">
        <it-button variant="primary" @click="toggle">Toggle dimmer</it-button>
      </div>
  ...
  <section class="my-5">
    ...
    <div data-demo-wrapper>
      <div class="mb-3 d-flex gap-2">
        <it-button variant="primary" @click="show">show()</it-button>
        <it-button variant="primary" outline @click="hide">hide()</it-button>
        <it-button variant="secondary" outline @click="toggle">toggle()</it-button>
      </div>
