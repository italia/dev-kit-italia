  ...
  <div>
    <section>
      ...
      <div style="display: flex; gap: 1rem; flex-wrap: wrap; align-items: center">
        <it-avatar
          v-for="size in ['xs', 'sm', 'md', 'lg', 'xl', 'xxl']"
          :key="size"
          type="image"
      ...
      <div style="display: flex; gap: 2rem; flex-wrap: wrap; align-items: center; justify-content: center">
        ...
        <div style="text-align: center; align-items: center; justify-content: center; display: flex">
          <it-avatar src="https://randomuser.me/api/portraits/men/25.jpg" alt="Foto profilo" status="notify" size="lg">
            ...
            >
              <span
                style="width: 8px; height: 8px; background: white; border-radius: 50%; display: inline-block"
              ></span>
    ...
    <!-- Gruppi avatar - Liste verticali e sovrapposti, dropdown, ecc. possono essere aggiunti qui seguendo lo stesso schema -->
  </div>
</template>
