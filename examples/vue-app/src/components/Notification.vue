<template>
  ...
  <section class="my-5">
    ...
    <div class="d-flex gap-3 flex-wrap">
      <div>
        ...
        <button class="btn btn-primary mt-3" @click="showNotification(notificationRef)">
          Mostra notifica
        </button>
      </div>
    </div>
  ...
  <section class="my-5">
    ...
    <div class="d-flex gap-3 flex-wrap">
      <div>
        ...
        <button class="btn btn-primary mt-3" @click="showNotification(notificationDismissableRef)">
  ...
  <section class="my-5">
    ...
    <div class="d-flex gap-3 flex-wrap">
      <div>
        ...
        <button class="btn btn-success mt-3" @click="showNotification(notificationSuccessRef)">
      ...
      <div>
        ...
        <button class="btn btn-danger mt-3" @click="showNotification(notificationErrorRef)">
      ...
      <div>
        ...
        <button class="btn btn-warning mt-3" @click="showNotification(notificationWarningRef)">
      ...
      <div>
        ...
        <button class="btn btn-info mt-3" @click="showNotification(notificationInfoRef)">
  ...
  <section class="my-5">
    ...
    <div class="d-flex gap-3 flex-wrap">
      <div>
        ...
        <button class="btn btn-outline-primary" @click="showNotificationByTarget">
          Mostra in alto
        </button>
      </div>
  ...
  <section class="my-5">
    ...
    <div class="d-flex gap-3 flex-wrap">
      <div>
        ...
        <button class="btn btn-primary mt-3" @click="showNotificationWithTimeout(2000)">
          Mostra (2s)
        </button>
      </div>
      ...
      <div>
        ...
        <button class="btn btn-primary mt-3" @click="showNotificationWithTimeout(5000)">
          Mostra (5s)
        </button>
      </div>
    </div>
  ...
  <section class="my-5">
    ...
    <div class="d-flex gap-3 flex-wrap">
      <div>
        <it-notification ref="notificationManualRef" dismissable icon="it-warning-circle" status="warning">
          <span slot="title">Notifica con chiusura manuale</span>
          <p>Clicca il pulsante per chiudere la notifica.</p>
        </it-notification>
        <button class="btn btn-warning mt-3" @click="showNotification(notificationManualRef)">
          Mostra notifica
        </button>
      </div>
    </div>
  ...
  <section class="my-5">
    ...
    <div class="d-flex gap-3 flex-wrap">
      <div>
        ...
        <button class="btn btn-outline-primary mt-3" @click="showNotificationByTarget">
          Mostra con h3
        </button>
      </div>
  ...
  <section class="my-5">
    ...
    <div class="d-flex gap-3 flex-wrap">
      <div>
        ...
        <button class="btn btn-success mt-3" @click="showNotificationByTarget">
      ...
      <div>
        ...
        <button class="btn btn-danger mt-3" @click="showNotificationByTarget">
          Mostra notifica di errore
        </button>
      </div>
    </div>
...
export default {
  ...
  methods: {
    ...
    showNotificationByTarget(event) {
      const notification = event.currentTarget.previousElementSibling;
      if (notification) {
        notification.show();
      }
    },
    showNotificationWithTimeout(timeout) {
