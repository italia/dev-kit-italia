...
<template>
  ...
  <section>
    ...
    <span class="badge rounded-pill badge-primary mx-1">Primary</span>
    <span class="badge rounded-pill badge-secondary mx-1">Secondary</span>
    <span class="badge rounded-pill badge-success mx-1">Success</span>
    <span class="badge rounded-pill badge-danger mx-1">Danger</span>
    <span class="badge rounded-pill badge-warning mx-1">Warning</span>
  </section>
  ...
  <section>
    ...
    <a href="#" class="badge badge-primary mx-1">Primary</a>
    <a href="#" class="badge badge-secondary mx-1">Secondary</a>
    <a href="#" class="badge badge-success mx-1">Success</a>
    <a href="#" class="badge badge-danger mx-1">Danger</a>
    <a href="#" class="badge badge-warning mx-1">Warning</a>
  </section>
</div>
