<template>
  ...
  <section style="margin-bottom: 2rem">
    <h2>Posizione</h2>
    <div style="display: grid; gap: 0.5rem; grid: 1fr 1fr 1fr / 1fr 1fr 1fr">
  ...
  <section style="margin-bottom: 2rem">
    <h2>Eventi</h2>
    <it-popover @it-popover-open="handlePopoverOpen" @it-popover-close="handlePopoverClose" placement="right">
