<template>
  <div class="container" style="padding: 2rem">
    <h1>Esempi Radio Button - Vue</h1>

    <!-- Esempio base -->
    <section style="margin-bottom: 3rem">
      <h2>Esempio Base</h2>
      <it-radio-group name="gruppo1" :value="selectedValue" @change="selectedValue = $event.target.value">
    ...
    <section style="margin-bottom: 3rem">
      ...
      <fieldset>
        ...
        <it-radio-group name="gruppo-inline" :value="selectedInline" @change="selectedInline = $event.target.value">
    ...
    <section style="margin-bottom: 3rem">
      ...
      <div class="row">
        <fieldset class="col-12 col-md-6">
          <legend>Gruppo di radio</legend>
          <it-radio-group name="gruppo-visual" :value="selectedGroup" @change="selectedGroup = $event.target.value">
...
const selectedValue = ref('opzione1');
const selectedInline = ref('opzione1');
const selectedGroup = ref('opzione1');
