...
<template>
  ...
  <section>
    ...
    <div class="flex">
      <it-button class="me-2" variant="success" size="lg" icon="{true}" type="button">
      ...
      <it-button class="me-2" variant="primary" icon="{true}" type="button">
      ...
      <it-button class="me-2" variant="danger" icon="{true}" type="button">
        <span class="rounded-icon">
      ...
      <it-button class="me-2" variant="secondary" size="xs" icon="{true}" type="button">
        <span class="rounded-icon">
