...
Come descritto nelle [indicazioni generali](#indicazioni-generali), puoi assegnare al trigger diversi tag validi per il [ruolo button](https://developer.mozilla.org/en-US/docs/Web/Accessibility/ARIA/Reference/Roles/button_role), valorizzando adeguatamente l'attributo `as`.
...
<p>
Il trigger è semanticamente un pulsante, perciò sono attualmente supportati solo gli stili Bootstrap Italia relativi ai pulsanti.
</p>
<p>
