...
- **default**: voce breadcrumb.Inserisci normalmente un link `<a>`, eventualmente con altri elementi inline
...
Per utilizzare la versione su sfondo scuro delle breadcrumbs, aggiungi l'attributo `dark`.
