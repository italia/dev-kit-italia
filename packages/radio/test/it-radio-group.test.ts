...
/**
 * Helper to wait for group AND child radios to be ready
 * Use this when you have `checked` or `disabled` attributes in HTML
 */
async function waitForGroupAndRadios(el: ItRadioGroup) {
