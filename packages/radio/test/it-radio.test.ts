...
//     const el = await fixture<ItRadio>(html`<it-radio name="test"> <span slot="label">Test label</span></it-radio>`);
...
//     // Leggiamo il contenuto slottato (light DOM)
//     const slotted = el.querySelector('span[slot="label"]');
//     expect(slotted?.textContent?.trim()).to.equal('Test label');
//   });
...
//       html`<it-radio name="test" checked><span slot="label">Test label</span></it-radio>`,
//     );
...
//   // NOTE: Mutual exclusion tests are now in it-radio-group.test.ts
//   // as the <it-radio-group> component is responsible for managing
//   // radio button selection within a group.

//   // Verifica lo stato disabilitato
//   it('should be disabled when disabled attribute is set', async () => {
//     const el = await fixture<ItRadio>(
//       html`<it-radio name="test" disabled><span slot="label">Test label</span></it-radio>`,
//     );
...
//     const el = await fixture<ItRadio>(
//       html`<it-radio name="test" inline><span slot="label">Test label</span></it-radio>`,
//     );
...
//     const el = await fixture<ItRadio>(
//       html`<it-radio name="test" group><span slot="label">Test label</span></it-radio>`,
//     );
...
//     const el = await fixture<ItRadio>(
//       html`<it-radio name="test" support-text="This is a help text"><span slot="label">Test label</span></it-radio>`,
//     );
...
//     const el = await fixture<ItRadio>(
//       html`<it-radio name="req-field" required><span slot="label">Test label</span></it-radio>`,
//     );
//     const input = el.shadowRoot?.querySelector('input')!;
//     input.focus();
//     input.blur();
...
//     const el = await fixture<ItRadio>(
//       html`<it-radio name="custom" validity-message="Errore personalizzato" custom-validation
//         ><span slot="label">Test label</span></it-radio
//       >`,
//     );
...
//     const el = await fixture<ItRadio>(
//       html`<it-radio required name="test"><span slot="label">Test label</span></it-radio>`,
//     );
//     const input = el.shadowRoot?.querySelector('input')!;
...
//       <div>
//         <form id="test-form">
//           <it-radio name="option" value="option1"><span slot="label">Test label</span></it-radio>
//           <it-radio name="option" value="option2" checked><span slot="label">Test label</span></it-radio>
//           <it-radio name="option" value="option3"><span slot="label">Test label</span></it-radio>
//         </form>
//       </div>
//     `);
...
//         <form id="test-form">
//           <it-radio name="option" value="option1"><span slot="label">Test label</span></it-radio>
//           <it-radio name="option" value="option2"><span slot="label">Test label</span></it-radio>
//         </form>
//       </div>
//     `);
...
//       <div>
//         <form id="test-form">
//           <it-radio name="option" value="option1" checked><span slot="label">Test label</span></it-radio>
//           <it-radio name="option" value="option2"><span slot="label">Test label</span></it-radio>
//         </form>
//       </div>
//     `);
...
//         <it-radio id="radio1" name="test-group" checked><span slot="label">Test label</span></it-radio>
//         <it-radio id="radio2" name="test-group"><span slot="label">Test label</span></it-radio>
//       </fieldset>
//     `);
...
//       const container = await fixture<HTMLDivElement>(html`
//         <div>
//           <it-radio id="radio1" name="kbd-group" value="opt1" checked><span slot="label">Test label</span></it-radio>
//           <it-radio id="radio2" name="kbd-group" value="opt2"><span slot="label">Test label</span></it-radio>
//           <it-radio id="radio3" name="kbd-group" value="opt3"><span slot="label">Test label</span></it-radio>
//         </div>
//       `);
...
//       const container = await fixture<HTMLDivElement>(html`
//         <div>
//           <it-radio id="radio1" name="kbd-group2" value="opt1" checked><span slot="label">Test label</span></it-radio>
//           <it-radio id="radio2" name="kbd-group2" value="opt2"><span slot="label">Test label</span></it-radio>
//           <it-radio id="radio3" name="kbd-group2" value="opt3"><span slot="label">Test label</span></it-radio>
//         </div>
//       `);
...
//       const container = await fixture<HTMLDivElement>(html`
//         <div>
//           <it-radio id="radio1" name="kbd-group3" value="opt1"><span slot="label">Test label</span></it-radio>
//           <it-radio id="radio2" name="kbd-group3" value="opt2"><span slot="label">Test label</span></it-radio>
//         </div>
//       `);
...
//       const container = await fixture<HTMLDivElement>(html`
//         <div>
//           <it-radio id="radio1" name="tab-group" value="opt1"><span slot="label">Test label</span></it-radio>
//           <it-radio id="radio2" name="tab-group" value="opt2" checked><span slot="label">Test label</span></it-radio>
//           <it-radio id="radio3" name="tab-group" value="opt3"><span slot="label">Test label</span></it-radio>
//         </div>
//       `);
...
//       const container = await fixture<HTMLDivElement>(html`
//         <div>
//           <it-radio id="radio1" name="tab-group2" value="opt1"><span slot="label">Test label</span></it-radio>
//           <it-radio id="radio2" name="tab-group2" value="opt2"><span slot="label">Test label</span></it-radio>
//           <it-radio id="radio3" name="tab-group2" value="opt3"><span slot="label">Test label</span></it-radio>
//         </div>
//       `);
...
//       const container = await fixture<HTMLDivElement>(html`
//         <div>
//           <it-radio id="radio1" name="kbd-group4" value="opt1" checked><span slot="label">Test label</span></it-radio>
//           <it-radio id="radio2" name="kbd-group4" value="opt2" disabled><span slot="label">Test label</span></it-radio>
//         </div>
//       `);
