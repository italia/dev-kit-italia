...
<p className="lead">Elenco di azioni o link a comparsa per risparmiare spazio e organizzare opzioni in modo compatto e coerente</p>
...
[Select](/docs/componenti-form-select--documentazione), [Autocomplete](/docs/componenti-form-autocomplete--documentazione) e [Radio button](/docs/componenti-form-radio--documentazione):
