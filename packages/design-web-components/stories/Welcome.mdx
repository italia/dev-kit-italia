...
<div class="mb-4">
  ...
  <div>
    <img src="./logo.png" width="500px" alt=".italia design web components" />
  </div>
  <p class="lead mb-5">Design Web Components è un set di Web components che implementa il Design system .italia e i componenti presenti su [UI Kit Italia](https://github.com/italia/design-ui-kit).</p>
</div>
