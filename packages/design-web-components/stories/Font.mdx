...
È necessario anche includere i file relativi ai font referenziati nel CSS della libreria. L’inclusione dei font può avviene includendo il bundle fornito dal pacchetto @italia/design-web-components, oppure utilizzando CSS.

## Via Bundle

E' disponibile il bundle dei font, includibile con:

```html
<link rel="stylesheet" href="design-web-components/design-web-components-fonts.css" />
```

## Via CSS

E' possibile definire i font via CSS. Per semplicità abbiamo utilizzato la sintassi SCSS in modo da utilizzare una variabile per specificare la path di base dove prendere i font.
