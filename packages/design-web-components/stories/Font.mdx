...
È necessario anche includere i file relativi ai caratteri tipografici referenziati nel CSS della libreria. L’inclusione dei font può avviene includendo il bundle fornito dal pacchetto `@italia/design-web-components`, oppure utilizzando CSS.
