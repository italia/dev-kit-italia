...
Il componente Sections (`it-section`), in italiano sezione, rappresenta un contenitore visivo per introdurre sezioni di contenuto con o senza immagine.
...
[Approfondisci come e quando usare il componente Sections](https://designers.italia.it/design-system/componenti/sections/)
...
Sono disponibili più varianti colore di sfondo per le sezioni, corrispondenti alle classi di Bootstrap Italia:

- `muted`;
- `emphasis`, applica automaticamente il testo bianco;
- `primary`, applica automaticamente il testo bianco.

Il componente Sections ha uno sfondo trasparente di default.

<Canvas of={Stories.VariantiColore} />

## Sezione con immagine decorativa

Per aggiungere un'immagine come sfondo della sezione, inserisci l'URL nell'attributo `image`. Le dimensioni dell'immagine si adattano automaticamente.
...
<div class="callout callout-warning">
  <div class="callout-inner">
    ...
    <p>
      Le card non sono ancora state implementate nel Dev Kit Italia. La sezione seguente è a scopo puramente esemplificativo e verrà aggiornata quando le card saranno disponibili.
    </p>
  </div>
</div>

Per aggiungere una serie di card all'interno di una sezione si consiglia di utilizzare le griglie per garantire un corretto margine fra gli elementi.
