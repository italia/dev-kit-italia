...
import * as Stories from './introduzione.stories';
...
Il contenitore, o _"container"_, è uno degli elementi base nell'utilizzo di Bootstrap Italia, ed è **richiesto quando si utilizza il [grid system](/docs/organizzare-gli-spazi-le-griglie--documentazione)**.
...
<Canvas of={Stories.ContainerFluido} />
...
Utilizza le [display utility](/docs/organizzare-gli-spazi-display--documentazione) insieme al grid system, i contenuti o i
...
[utility flexbox](/docs/organizzare-gli-spazi-flex--documentazione) per così modificarne il dimensionamento, l'allineamento, la
spaziatura e altro ancora.

## Margin e padding

Si utilizzino il `margin` e `padding` delle [utility spaziatura](/docs/organizzare-gli-spazi-spaziatura--documentazione) per gestire spazi
...
Quando è necessario nascondere o rendere visibile un elemento si possono usare le [utility di visibilità](/docs/organizzare-gli-spazi-display--documentazione#visibilità).
