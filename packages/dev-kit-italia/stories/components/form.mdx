...
## Cosa fa
Il componente `<form>` serve a raccogliere e inviare dati inseriti dall’utente.

Raggruppa campi come input, select e textarea e definisce come e dove questi dati verranno inviati quando l’utente invia il modulo (submit).
Gestisce inoltre gli eventi di invio, e può essere personalizzato per supportare diverse modalità di interazione e invio dei dati.

[Approfondisci come e quando usare il componente Input](https://designers.italia.it/design-system/componenti/form/)
