...
Esempio di navigazione annidata collassabile. Per questo tipo di link list sono stati utilizzati, oltre alle classi custom, i componenti [Collapse](/docs/componenti-collapse--documentazione) e [Icon](/docs/componenti-icon--documentazione).
