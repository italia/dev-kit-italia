...
- **Supporto alla documentazione**: integrazione nativa con Storybook.
...
- Include SCSS nel proprio shadow DOM
...
all'upgrade dedicata](/docs/migrazione--documentazione#migrazione-da-bootstrap-italia).
...
<it-callout variant="primary" heading-level="h3">
  ...
  <p>Nella cartella `examples` della root del progetto, sono forniti e documentati per gli utilizzatori finali gli snippet HTML da utilizzare sia in ambiente JS vanilla, che nei framework React, Angular, Vue, Svelte</p>
</it-callout>
