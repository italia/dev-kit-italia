...
## Cosa fa
Il componente Timepicker (`it-input` `type="time"`) consente all'utente di selezionare un orario con ore e minuti, digitandolo manualmento o selezionando opzioni prestabiliti.
