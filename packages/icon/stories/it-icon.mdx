...
Il componente `it-icon` ti consente di visualizzare una delle icone SVG disponibili nel Design System, usare un'icona SVG proprietaria o un'icona SVG tramite URL.
...
È possibile utilizzare l'attributo `align` per posizionare le icone all'interno di un elemento. I valori disponibili sono: `top`, `middle`, `bottom`.
