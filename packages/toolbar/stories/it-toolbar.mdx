...
Implementano gli le specifiche ARIA [WAI Aria per il pattern Toolbar](https://www.w3.org/WAI/ARIA/apg/patterns/toolbar/) per garantire che gli utenti con disabilità possano navigare e interagire con la toolbar in modo efficace.
