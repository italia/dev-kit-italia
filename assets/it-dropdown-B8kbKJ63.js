import{j as e,M as s,T as c,C as n,a as d}from"./blocks-HeM7HRRU.js";import{useMDXComponents as l}from"./index-BNB5zOl4.js";import{S as a,B as t,V as u,P as h,M as p,a as m,b as x,c as j,d as g,e as z,f,g as v,h as b,i as w}from"./it-dropdown.stories-xhu3_fUe.js";import"./preload-helper-PPVm8Dsz.js";import"./iframe-BBsXzWsk.js";function r(o){const i={a:"a",code:"code",h2:"h2",h3:"h3",li:"li",p:"p",strong:"strong",ul:"ul",...l(),...o.components};return e.jsxs(e.Fragment,{children:[e.jsx(s,{of:a}),`
`,e.jsx(c,{of:a}),`
...
`,e.jsxs(i.p,{children:["Per impostazione predefinita, il componente ",e.jsx(i.code,{children:"it-dropdown"})," usa la semantica di una semplice lista HTML (",e.jsx(i.code,{children:"<ul>"}),"/",e.jsx(i.code,{children:"<li>"}),"), senza ruoli ARIA aggiuntivi. Questa è la scelta corretta nella maggior parte dei casi, in particolare quando il menu contiene link di navigazione o si trova all'interno di un elemento ",e.jsx(i.code,{children:"<nav>"})," (ad es. header, megamenu)."]}),`
`,e.jsxs(i.p,{children:["Lo standard ",e.jsx(i.a,{href:"https://www.w3.org/TR/wai-aria/",rel:"nofollow",children:"WAI ARIA"})," definisce il ",e.jsx(i.a,{href:"https://www.w3.org/TR/wai-aria/#menu",rel:"nofollow",children:e.jsx(i.code,{children:'role="menu"'})})," per i ",e.jsx(i.strong,{children:"menu applicativi"}),`, ovvero menu che espongono comandi o azioni (come "Copia", "Taglia", "Incolla") in modo analogo ai menu di un'applicazione desktop. Puoi usarlo impostando l'attributo `,e.jsx(i.code,{children:'it-role="menu"'}),", che assegna automaticamente il ruolo corretto anche agli elementi interni."]}),`
`,e.jsxs("it-callout",{variant:"warning","heading-level":"h3",children:[e.jsx("span",{slot:"title",children:"Attenzione"}),e.jsxs("p",{children:[e.jsx(i.code,{children:'role="menu"'})," non è adatto a menu di navigazione o a menu che contengono link a pagine. Non usarlo all'interno di un elemento ",e.jsx(i.code,{children:"<nav>"}),"."]})]}),`
...
`,e.jsxs(i.p,{children:["Dovrai inserire un'etichetta per il pulsante di attivazione del menu tramite l'attributo ",e.jsx(i.code,{children:"label"}),`, che verrà letta dagli screen reader.
...
`,e.jsx(n,{of:b}),`
`,e.jsx(i.h3,{id:"menu-azioni",children:"Menu azioni"}),`
`,e.jsxs(i.p,{children:["Usa ",e.jsx(i.code,{children:'it-role="menu"'}),` quando il dropdown espone comandi o azioni applicative (non link di navigazione).
In questo caso il componente assegna automaticamente `,e.jsx(i.code,{children:'role="menuitem"'})," agli elementi interni."]}),`
`,e.jsx(n,{of:w})]})}function D(o={}){const{wrapper:i}={...l(),...o.components};return i?e.jsx(i,{...o,children:e.jsx(r,{...o})}):r(o)}export{D as default};
