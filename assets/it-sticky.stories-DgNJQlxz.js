import{o as e,A as i,b as f}from"./iframe-CEKgHznA.js";function b({stackable:c,paddingTop:d,stickyClassName:p,positionType:m,position:u,triggerOffset:g,triggerSelector:y}){return f`
    <it-sticky
      ?stackable=${e(c)}
      padding-top=${e(d||i)}
      sticky-class-name=${e(p||i)}
      trigger-offset=${e(g||i)}
      trigger-selector=${e(y||i)}
      position-type=${e(m||i)}
      position=${e(u||i)}
    >
      <div class="bg-primary text-white p-3">Elemento Sticky</div>
    </it-sticky>
  `}const k={title:"Componenti/Sticky",component:"it-sticky",tags:["autodocs","a11y-ok","web-component"],args:{stackable:!1,paddingTop:0,stickyClassName:void 0,positionType:void 0,triggerOffset:void 0,triggerSelector:void 0,position:void 0},parameters:{docs:{description:{component:`<Description>Rende un elemento della pagina costantemente visibile allo scorrere della pagina.</Description>
...
`}}},argTypes:{stackable:{control:"boolean",description:"Attiva/disattiva la possibilità di rendere l'elemento impilabile su altri elementi sticky presenti in pagina",table:{defaultValue:{summary:!1}}},paddingTop:{name:"padding-top",control:"number",description:"Indica la distanza dall'elemento in sticky dal margine superiore",table:{defaultValue:{summary:0}}},stickyClassName:{name:"sticky-class-name",control:"text",description:"Classi CSS da applicare all'elemento quando viene attivata la funzionalità sticky",table:{defaultValue:{summary:""}}},positionType:{name:"position-type",control:{type:"select"},options:["sticky","fixed"],description:"Indica il valore della proprietà CSS `position`. I valori ammessi sono `sticky` o `fixed`",table:{defaultValue:{summary:"sticky"}}},triggerOffset:{name:"trigger-offset",control:"number",description:"Definisce un offset in pixel tra l'elemento e il margine superiore per ritardare l'attivazione dello sticky",table:{defaultValue:{summary:void 0}}},triggerSelector:{name:"trigger-selector",control:"text",description:"Selettore CSS di un elemento della pagina da usare come soglia di attivazione dello sticky",table:{defaultValue:{summary:void 0}}},position:{control:{type:"select"},options:["top","bottom"],description:"Indica il bordo del viewport a cui agganciare l'elemento. Usa `'bottom'` con `position-type=\"fixed\"` per una barra persistente in fondo alla pagina.",table:{defaultValue:{summary:"top"}}}},render:c=>b(c)},t={name:"Esempio interattivo",tags:["!autodocs","!dev"],parameters:{docs:{canvas:{sourceState:"shown"}}}},o={name:"Offset",args:{paddingTop:50},parameters:{docs:{description:{story:`
...
È disponibile una <a href="iframe.html?globals=&id=esempi-sticky--fixed-sticky&viewMode=story" target="_blank" rel="noopener">
  ...
  <div class="bg-primary text-white p-3">Elemento Sticky</div>
</it-sticky>`}}}},n={name:"Classi personalizzate",args:{stickyClassName:"bg-light text-black"},parameters:{docs:{description:{story:`
...
È disponibile una <a href="iframe.html?globals=&id=esempi-sticky--fixed-stick-classnamey&viewMode=story" target="_blank" rel="noopener">
  pagina di esempio
        ...
        `}}}},s={name:"Versione impilabile",args:{stackable:!0,paddingTop:0,stickyClassName:""},parameters:{docs:{description:{story:`
...
<br> Un'altra <a href="iframe.html?globals=&id=esempi-sticky--stackable-sticky-resize&viewMode=story" target="_blank" rel="noopener">
  pagina di esempio
        ...
        `}}}},r={name:"Eventi Custom",parameters:{viewMode:"docs",docs:{canvas:{hidden:!0,sourceState:"none"},description:{story:`
...
\`\`\`
        `}}}},l={name:"Position fixed bottom",parameters:{docs:{description:{story:`
...
È disponibile una <a href="iframe.html?globals=&id=esempi-sticky--fixed-bottom-sticky&viewMode=story" target="_blank" rel="noopener">
  pagina di esempio
        ...
        `},source:{code:`<it-sticky position="bottom" position-type="fixed">
  <div class="bg-primary text-white p-3">Barra fissa in fondo</div>
</it-sticky>`}}}};t.parameters={...t.parameters,docs:{...t.parameters?.docs,source:{originalSource:`{
...
}`,...l.parameters?.docs?.source}}};const v=["Base","TopOffset","Fixed","CustomClass","Stackable","CustomEvents","FixedBottom"],h=Object.freeze(Object.defineProperty({__proto__:null,Base:t,CustomClass:n,CustomEvents:r,Fixed:a,FixedBottom:l,Stackable:s,TopOffset:o,__namedExportsOrder:v,default:k},Symbol.toStringTag,{value:"Module"}));export{t as B,n as C,a as F,h as S,o as T,s as a,l as b};
