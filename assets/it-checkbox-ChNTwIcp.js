import{j as e,M as c,C as o,a as h,D as l}from"./blocks-DGm5YkTy.js";import{useMDXComponents as s}from"./index-DbevRHTU.js";import{S as p,E as r,D as x,I as u,G as m,a as j,b as g,c as b,V as v,d as f,e as t,M as a}from"./it-checkbox.stories-LhcT4DY8.js";import"./preload-helper-PPVm8Dsz.js";import"./iframe-Ug63oIzY.js";import"./formControlReusableStories-Dn0Robr1.js";function d(n){const i={a:"a",code:"code",em:"em",h1:"h1",h2:"h2",h3:"h3",h4:"h4",li:"li",p:"p",pre:"pre",strong:"strong",ul:"ul",...s(),...n.components};return e.jsxs(e.Fragment,{children:[e.jsx(c,{of:p}),`
`,e.jsx(i.h1,{id:"checkbox",children:"Checkbox"}),`
`,e.jsx("description",{children:"Casella di controllo che consente di selezionare una o più opzioni da un elenco predefinito."}),`
`,e.jsx(i.h2,{id:"cosa-fa",children:"Cosa fa"}),`
`,e.jsxs(i.p,{children:["Il componente Checkbox (",e.jsx(i.code,{children:"it-checkbox"}),") permette all’utente di selezionare o deselezionare una o più opzioni in modo indipendente, utile quando sono consentite scelte multiple."]}),`
...
`,e.jsxs(i.p,{children:["Per creare un gruppo di checkbox, racchiudi tutti gli elementi ",e.jsx(i.code,{children:"<it-checkbox>"})," all'interno del componente ",e.jsx(i.code,{children:"<it-checkbox-group>"})," e assegna al gruppo l'attributo ",e.jsx(i.code,{children:"name"})," corrispondente al nome del campo da salvare nel form."]}),`
`,e.jsxs(i.p,{children:["Sul componente ",e.jsx(i.code,{children:"<it-checkbox-group>"})," sono disponibili alcuni attributi che si riflettono automaticamente sugli ",e.jsx(i.code,{children:"<it-checkbox>"})," figli, senza doverli replicare in ognuno di essi."]}),`
...
`,e.jsxs(i.li,{children:[e.jsx(i.code,{children:"group"}),", applica lo stile di default ",e.jsx(i.em,{children:"gruppo di checkbox"}),";"]}),`
...
`,e.jsxs(i.p,{children:["Quando utilizzi il componente ",e.jsx(i.code,{children:"it-checkbox-group"})," in un form, il modo corretto per estrarre il valore del campo al submit via JS è:"]}),`
...
`,e.jsxs(i.p,{children:["È lo stile di default del gruppo di checkbox ed equivale a impostare l'attributo ",e.jsx(i.code,{children:"group"})," su ",e.jsx(i.code,{children:"<it-checkbox-group>"}),"."]}),`
...
`,e.jsx(l,{of:a}),`
`,e.jsx(o,{of:a})]})}function I(n={}){const{wrapper:i}={...s(),...n.components};return i?e.jsx(i,{...n,children:e.jsx(d,{...n})}):d(n)}export{I as default};
