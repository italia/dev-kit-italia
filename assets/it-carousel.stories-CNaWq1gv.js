import{b as r,o as S,A as b}from"./iframe-B5mMrHNl.js";const C={$code:"it",$name:"Italiano",$dir:"ltr",carousel_prev:"Slide precedente",carousel_next:"Slide successiva",carousel_first:"Vai alla prima slide",carousel_last:"Vai all'ultima slide",carousel_slideX:"Vai alla slide %s",carousel_pageX:"Vai a pagina %s",carousel_play:"Attiva autoplay",carousel_pause:"Pausa autoplay",carousel_carousel:"carosello",carousel_select:"Seleziona una slide da mostrare",carousel_slide:"slide",carousel_slideLabel:"%s di %s",carousel_startautoplay:"Attiva autoplay",carousel_stopautoplay:"Spegni autoplay"},w=["single","columns","gallery-sm","gallert-lg"],z=(e,v,h)=>r` <it-card full-height="">
  ...
  </it-card>`,t=(e,v)=>v?.type==="video"?r`<it-carousel-slide>
      <it-video
        ...
        track="[]"
      ></it-video>
    </it-carousel-slide>`:v?.type==="image"?r`<it-carousel-slide>
    ...
    </it-carousel-slide>`:v?.type==="cardWithImage"?r`<it-carousel-slide>${z(!0,void 0,e)}</it-carousel-slide>`:r`<it-carousel-slide>${z(!1,void 0,e)}</it-carousel-slide>`,a=e=>r`
  <it-carousel
    variant=${e.variant}
...
\`\`\`js
const translation = ${JSON.stringify(C,null,2)}
\`\`\`
...
}`,...f.parameters?.docs?.source}}};const O=["EsempioInterattivo","VarianteSingola","Variante3Colonne","VarianteGallerySM","VarianteGalleryLG","ConFrecce1","Fullscreen","Separator","TipoScorrimento","Autoplay","ConfigurazioneAvanzata","VideoTest","I18n"],T=Object.freeze(Object.defineProperty({__proto__:null,Autoplay:m,ConFrecce1:d,ConfigurazioneAvanzata:g,EsempioInterattivo:o,Fullscreen:c,I18n:f,Separator:p,TipoScorrimento:u,Variante3Colonne:n,VarianteGalleryLG:l,VarianteGallerySM:s,VarianteSingola:i,VideoTest:y,__namedExportsOrder:O,default:V},Symbol.toStringTag,{value:"Module"}));export{m as A,d as C,o as E,c as F,f as I,T as S,u as T,i as V,n as a,s as b,l as c,p as d,g as e};
