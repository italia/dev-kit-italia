import{b as s,o as n}from"./iframe-DTKPvNQN.js";const g=["top","bottom"],v=[null,"left","right"],b=[null,"mobile","desktop","always"],f=(e,a=!0)=>s`<div class="link-list-wrapper">
    <h3>Header</h3>
    ${a?s`
          <div class="progress">
            <div
  ...
  </div>`,h=e=>s`<div class="inline-menu">
    ...
    <div class="row row-column-border border-light row-column-menu-left bg-white">
      <aside class="col-lg-4 ${e["line-position"]==="left"?"order-2":""}" aria-label="Indice della pagina">
        ...
        >
          ${e._inlineMenu?h(a):f(a,e._progress)}
        </it-navscroll>
      </aside>
      <main
...
}`,...d.parameters?.docs?.source}}};const q=["EsempioInterattivo","DesktopOnLeft","DesktopOnRight","MobileBottom","MobileTop","Progress","DarkModeStory","MenuInline"],I=Object.freeze(Object.defineProperty({__proto__:null,DarkModeStory:p,DesktopOnLeft:o,DesktopOnRight:l,EsempioInterattivo:r,MenuInline:d,MobileBottom:u,MobileTop:m,Progress:c,__namedExportsOrder:q,default:i},Symbol.toStringTag,{value:"Module"}));export{o as D,r as E,u as M,c as P,I as S,l as a,m as b,p as c,d};
