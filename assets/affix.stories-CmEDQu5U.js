import{b as u}from"./iframe-D9yc0utV.js";const a={title:"Componenti/Affix",tags:["documentation","new","a11y-ok"]},i={...a,name:"Affix top",parameters:{docs:{description:{story:`
...
`}}},render:()=>u` <h4 class="h6">Esempio 1:</h4>
      ...
      </div>`},e={...a,name:"Affix bottom",parameters:{docs:{description:{story:`
...
<div class="mt-5" style="font-size:0.9rem">Scorri il contenuto dell'esempio qui sotto per vedere l'effetto dell'affix.</div>`}}},render:()=>u`<h4 class="h6">Esempio 1:</h4>
      <div class="affix-example container border bg-white mb-4">
        <p>
          Mauris placerat commodo tincidunt. Mauris finibus hendrerit molestie. Vestibulum gravida, lectus sed semper
          fringilla, libero felis vehicula quam, at efficitur nisl justo mattis orci. Interdum et malesuada fames ac
...
\`
  ...
  render: () => html\` <h4 class="h6">Esempio 1:</h4>
      <div class="affix-example container border bg-white mb-4">
        <div class="row">
          <div class="col-6 col-md-3 p-2 affix-parent">
            <div class="neutral-1-bg-a7 p-3 mb-1">
...
}`,...e.parameters?.docs?.source}}};const s=["AffixTop","AffixBottom"],l=Object.freeze(Object.defineProperty({__proto__:null,AffixBottom:e,AffixTop:i,__namedExportsOrder:s,default:a},Symbol.toStringTag,{value:"Module"}));export{l as A,i as a,e as b};
