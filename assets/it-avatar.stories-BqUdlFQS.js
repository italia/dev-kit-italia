import{b as a,o as i,A as s}from"./iframe-Ug63oIzY.js";const b=["xs","sm","md","lg","xl","xxl"],R=["primary","secondary"],T=["image","text","icon"],M=["active","busy","hidden"],w=["approved","declined","notify"],t=e=>a`
  <it-avatar
    type="${i(e.type||s)}"
    size="${i(e.size||s)}"
    variant="${i(e.variant||s)}"
    presence="${i(e.presence||s)}"
    status="${i(e.status||s)}"
    src="${i(e.src||s)}"
    alt="${i(e.alt||s)}"
    text="${i(e.text||s)}"
...
`}}},render:()=>a`
    <div class="d-flex align-items-center justify-content-around flex-wrap flex-sm-nowrap gap-4">
      ${t({type:"image",src:"https://randomuser.me/api/portraits/women/44.jpg",alt:"Luisa Neri",size:"xs"})}
      ${t({type:"image",src:"https://randomuser.me/api/portraits/women/44.jpg",alt:"Luisa Neri",size:"sm"})}
      ${t({type:"image",src:"https://randomuser.me/api/portraits/men/43.jpg",alt:"Gioacchino Romani",size:"md"})}
      ${t({type:"image",src:"https://randomuser.me/api/portraits/women/41.jpg",alt:"Anna Barbieri",size:"lg"})}
      ${t({type:"image",src:"https://randomuser.me/api/portraits/men/33.jpg",alt:"Carlo Poli",size:"xl"})}
      ${t({type:"image",src:"https://randomuser.me/api/portraits/women/90.jpg",alt:"Giovanna Ferrero",size:"xxl"})}
    </div>
...
`}}},render:()=>a`
    <div class="d-flex align-items-center justify-content-around flex-wrap flex-sm-nowrap mb-3 gap-4">
      ${t({type:"text",text:"Mario Rossi",avatarTitle:"Mario Rossi",size:"xs"})}
      ${t({type:"text",text:"Mario Rossi",avatarTitle:"Mario Rossi",size:"sm"})}
      ${t({type:"text",text:"Mario Rossi",avatarTitle:"Mario Rossi",size:"md"})}
      ${t({type:"text",text:"Mario Rossi",avatarTitle:"Mario Rossi",size:"lg"})}
      ${t({type:"text",text:"Mario Rossi",avatarTitle:"Mario Rossi",size:"xl"})}
      ${t({type:"text",text:"Mario Rossi",avatarTitle:"Mario Rossi",size:"xxl"})}
    </div>
    <div class="d-flex align-items-center justify-content-around flex-wrap flex-sm-nowrap mb-3 gap-4">
      ${t({type:"text",text:"Mario Rossi",avatarTitle:"Mario Rossi",variant:"primary",size:"xs"})}
      ${t({type:"text",text:"Mario Rossi",avatarTitle:"Mario Rossi",variant:"primary",size:"sm"})}
      ${t({type:"text",text:"Mario Rossi",avatarTitle:"Mario Rossi",variant:"primary",size:"md"})}
      ${t({type:"text",text:"Mario Rossi",avatarTitle:"Mario Rossi",variant:"primary",size:"lg"})}
      ${t({type:"text",text:"Mario Rossi",avatarTitle:"Mario Rossi",variant:"primary",size:"xl"})}
      ${t({type:"text",text:"Mario Rossi",avatarTitle:"Mario Rossi",variant:"primary",size:"xxl"})}
    </div>
    <div class="d-flex align-items-center justify-content-around flex-wrap flex-sm-nowrap gap-4">
      ${t({type:"text",text:"Mario Rossi",avatarTitle:"Mario Rossi",variant:"secondary",size:"xs"})}
      ${t({type:"text",text:"Mario Rossi",avatarTitle:"Mario Rossi",variant:"secondary",size:"sm"})}
      ${t({type:"text",text:"Mario Rossi",avatarTitle:"Mario Rossi",variant:"secondary",size:"md"})}
      ${t({type:"text",text:"Mario Rossi",avatarTitle:"Mario Rossi",variant:"secondary",size:"lg"})}
      ${t({type:"text",text:"Mario Rossi",avatarTitle:"Mario Rossi",variant:"secondary",size:"xl"})}
      ${t({type:"text",text:"Mario Rossi",avatarTitle:"Mario Rossi",variant:"secondary",size:"xxl"})}
    </div>
...
`}}},render:()=>a`
    <div class="d-flex align-items-center justify-content-around flex-wrap flex-sm-nowrap gap-4">
      ${t({type:"icon",icon:"it-user",avatarTitle:"Utente",size:"xs"})}
      ${t({type:"icon",icon:"it-user",avatarTitle:"Utente",size:"sm"})}
      ${t({type:"icon",icon:"it-user",avatarTitle:"Utente",size:"md"})}
      ${t({type:"icon",icon:"it-user",avatarTitle:"Utente",size:"lg"})}
      ${t({type:"icon",icon:"it-user",avatarTitle:"Utente",size:"xl"})}
      ${t({type:"icon",icon:"it-user",avatarTitle:"Utente",size:"xxl"})}
    </div>
  `},c={argTypes:{href:{table:{disable:!0}}},parameters:{docs:{description:{story:"\nPer associare un avatar ad un'azione o un link, utilizzare l'attributo `href` con relativo link o chiamata JavaScript.\n"}}},render:()=>a`
    <div>
      <div class="d-flex align-items-center gap-3 flex-wrap">
        ${t({type:"image",src:"https://randomuser.me/api/portraits/women/41.jpg",alt:"Anna Barbieri",href:"#",avatarTitle:"Anna Barbieri"})}
        ${t({type:"text",text:"Mario Rossi",href:"#",avatarTitle:"Mario Rossi"})}
        ${t({type:"text",text:"Mario Rossi",variant:"primary",href:"#",avatarTitle:"Mario Rossi"})}
        ${t({type:"icon",icon:"it-user",href:"#",avatarTitle:"Utente"})}
      </div>
    </div>
  `},d={name:"Avatar link con tooltip",argTypes:{href:{table:{disable:!0}}},parameters:{docs:{description:{story:`
...
\`\`\`
`}}},decorators:[e=>a`<div style="padding:60px 0 20px;">${e()}</div>`],render:()=>a`
    <div>
      <div class="d-flex align-items-center gap-3 flex-wrap">
        <it-tooltip placement="left">
          ${t({type:"image",src:"https://randomuser.me/api/portraits/women/41.jpg",alt:"Anna Barbieri",href:"#",avatarTitle:"Anna Barbieri",slot:"trigger"})}
          <span slot="content"><strong>Anna Barbieri</strong><br /><em>Amministratore</em></span>
        </it-tooltip>
        <it-tooltip placement="top">
          ${t({type:"text",text:"Mario Rossi",href:"#",avatarTitle:"Mario Rossi",slot:"trigger"})}
          <span slot="content"><strong>Mario Rossi</strong><br /><em>Editor</em></span>
        </it-tooltip>
        <it-tooltip placement="right">
          ${t({type:"icon",icon:"it-search",href:"#",avatarTitle:"Cerca",slot:"trigger"})}
          <span slot="content"><strong>Cerca</strong><br /><em>Archivio notizie</em></span>
        </it-tooltip>
      </div>
    </div>
  `},m={name:"Comportamento - Presenza utente",argTypes:{presence:{table:{disable:!0}}},parameters:{docs:{description:{story:`
...
`}}},render:()=>a`
      ...
      <div>
        ...
        <div class="d-flex align-items-center gap-4 flex-wrap">
          <div class="text-center">
            ${t({type:"image",src:"https://randomuser.me/api/portraits/men/43.jpg",alt:"Mario Rossi",presence:"active",size:"lg"})}
            <div class="mt-2"><small>Attivo</small></div>
          </div>
          <div class="text-center">
            ${t({type:"image",src:"https://randomuser.me/api/portraits/women/41.jpg",alt:"Luisa Neri",presence:"busy",size:"lg"})}
            <div class="mt-2"><small>Non disponibile</small></div>
          </div>
          <div class="text-center">
            ${t({type:"image",src:"https://randomuser.me/api/portraits/men/33.jpg",alt:"Gioacchino Romani",presence:"hidden",size:"lg"})}
  ...
  `},v={name:"Comportamento - Status utente",argTypes:{status:{table:{disable:!0}}},parameters:{docs:{description:{story:`
...
`}}},render:()=>a`
    <div style="display: flex; flex-direction: column; gap: 2rem;">
      ...
      <div>
        ...
        <div class="d-flex align-items-center gap-4 flex-wrap">
          <div class="text-center">
            ${t({type:"image",src:"https://randomuser.me/api/portraits/men/43.jpg",alt:"Mario Rossi",status:"approved",size:"lg"})}
            <div class="mt-2"><small>Approvato</small></div>
          </div>
          <div class="text-center">
            ${t({type:"image",src:"https://randomuser.me/api/portraits/women/41.jpg",alt:"Luisa Neri",status:"declined",size:"lg"})}
            <div class="mt-2"><small>Respinto</small></div>
          </div>
          <div class="text-center">
            ${t({type:"image",src:"https://randomuser.me/api/portraits/men/33.jpg",alt:"Gioacchino Romani",status:"notify",size:"lg"})}
  ...
  `},u={name:"Gruppi di avatar - Liste verticali",parameters:{docs:{description:{story:`
...
`}}},render:()=>a`
          ...
          <ul class="link-list avatar-group">
            <li>
              <a class="list-item" href="#">
                ${t({size:"sm",src:"https://randomuser.me/api/portraits/men/43.jpg"})}
                <span>Mario Rossi</span>
              </a>
            </li>
            <li>
              <a class="list-item" href="#">
                ${t({size:"sm",src:"https://randomuser.me/api/portraits/women/44.jpg"})}
                <span>Anna Verdi</span>
              </a>
            </li>
            <li>
              <a class="list-item" href="#">
                ${t({size:"sm",text:"Sara Ghione",variant:"primary",type:"text"})}
                <span>Sara Ghione</span>
              </a>
            </li>
            <li>
              <a class="list-item" href="#">
                ${t({size:"sm",icon:"it-user",type:"icon"})}
      ...
      <div style="flex: 1; min-width: 300px;">
        ...
        <div class="link-list-wrapper">
          <ul class="link-list avatar-group">
            <li>
              <a class="list-item" href="#">
                ${t({src:"https://randomuser.me/api/portraits/men/32.jpg"})}
                <span>Luca Bianchi</span>
              </a>
            </li>
            <li>
              <a class="list-item" href="#">
                ${t({src:"https://randomuser.me/api/portraits/women/28.jpg"})}
                <span>Elena Rossi</span>
              </a>
            </li>
            <li>
              <a class="list-item" href="#">
                ${t({text:"Marco Neri",variant:"secondary",type:"text"})}
                <span>Marco Neri</span>
              </a>
            </li>
            <li>
              <a class="list-item" href="#">
                ${t({icon:"it-user",type:"icon"})}
  ...
  `},g={name:"Gruppi di avatar - Avatar Sovrapposti",parameters:{docs:{description:{story:`
...
`}}},render:()=>a`
    <div style="display: flex; flex-direction: column; gap: 3rem; height: 300px;">
      <div>
        <ul class="avatar-group-stacked">
          ...
          <li>
            ${t({type:"text",text:"Giulia Neri",variant:"primary",href:"#",avatarTitle:"Giulia Neri",slot:"trigger"})}
          </li>
  ...
  `},x={name:"Gruppi di avatar - Avatar Sovrapposti Piccoli",render:()=>a`
  ...
  `},z={name:"Gruppi di avatar - Avatar Sovrapposti Medi",render:()=>a`
    <div style="display: flex; flex-direction: column; gap: 3rem;">
      <div>
        <div>
          <ul class="avatar-group-stacked">
  ...
  `},h={name:"Gruppi di avatar - Liste verticali con testo aggiuntivo",parameters:{docs:{description:{story:`
...
\`
  ...
  \`
}`,...h.parameters?.docs?.source}}};const A=["EsempioInterattivo","PersonalizzazioneDegliStili","AvatarConImmagine","AvatarConTesto","AvatarConIcona","AvatarLink","AvatarLinkConTooltip","ComportamentoPresenzaUtente","ComportamentoStatusUtente","GruppiAvatarListe","AvatarSovrapposti","AvatarSovrappostiSM","AvatarSovrappostiMD","AvatarConTestoAggiuntivo","GruppiAvatarConTesto"],S=Object.freeze(Object.defineProperty({__proto__:null,AvatarConIcona:p,AvatarConImmagine:o,AvatarConTesto:l,AvatarConTestoAggiuntivo:y,AvatarLink:c,AvatarLinkConTooltip:d,AvatarSovrapposti:g,AvatarSovrappostiMD:z,AvatarSovrappostiSM:x,ComportamentoPresenzaUtente:m,ComportamentoStatusUtente:v,EsempioInterattivo:n,GruppiAvatarConTesto:h,GruppiAvatarListe:u,PersonalizzazioneDegliStili:r,__namedExportsOrder:A,default:f},Symbol.toStringTag,{value:"Module"}));export{S as A,m as C,n as E,u as G,o as a,l as b,p as c,c as d,d as e,v as f,h as g,g as h,x as i,z as j,y as k};
