import{b as i,A as c,o as u}from"./iframe-R3-NR_41.js";const p=["muted","emphasis","primary"],g=i`
  <div class="container">
    <div class="row mb-3">
      <div class="col-12">
...
`;function r({variant:e,image:l,content:d,inverse:m=!1}){return i`
    <it-section variant="${e||c}" image="${l||c}" ?inverse="${u(m)}">
      <!-- contenuto di esempio START -->
      ${d||g}
      <!-- contenuto di esempio END -->
    </it-section>
  `}const v={title:"Componenti/Section",tags:["a11y-ok","web-component"],component:"it-section",parameters:{docs:{layout:"padded",description:{component:`<Description>Sezione per raggruppare contenuti coerenti e con sfondi dedicati</Description>
...
}`,...t.parameters?.docs?.source}}};const b=["EsempioInterattivo","PersonalizzazioneDegliStili","VariantiColore","VarianteConImmagine","SectionConCard"],f=Object.freeze(Object.defineProperty({__proto__:null,EsempioInterattivo:a,PersonalizzazioneDegliStili:n,SectionConCard:t,VarianteConImmagine:s,VariantiColore:o,__namedExportsOrder:b,default:v},Symbol.toStringTag,{value:"Module"}));export{a as E,n as P,f as S,o as V,s as a,t as b};
