import{b as i,o as p}from"./iframe-BAOCzTeu.js";const b=["primary","dark"],r=t=>{t.currentTarget.closest("[data-demo-wrapper]")?.querySelector("it-dimmer")?.toggle()},g=t=>{t.currentTarget.closest("[data-demo-wrapper]")?.querySelector("it-dimmer")?.show()},y=t=>{t.currentTarget.closest("[data-demo-wrapper]")?.querySelector("it-dimmer")?.hide()},e=i`
  <div class="row">
