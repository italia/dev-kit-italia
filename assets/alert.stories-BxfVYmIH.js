import{b as r}from"./iframe-Dq0Es6_d.js";const l={title:"Componenti/Alert",tags:["a11y-ok","documentation"],parameters:{layout:"padded"}},e={decorators:[n=>r`<div style="display:flex;flex-direction:column;gap:1rem">${n()}</div>`],render:()=>r`
