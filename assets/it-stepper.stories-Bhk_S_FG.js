import{b,o as a}from"./iframe-Cl3Kz-XE.js";const h=["text","icons","numbers"],x=["bar","dots",""],f=[{label:"Primo contenuto",icon:"it-calendar"},{label:"Secondo contenuto",icon:"it-lock"},{label:"Terzo contenuto",icon:"it-settings"}],y=b`
  <style>
...
`,E=[(e,o)=>{const s=o.parameters.stepperDemo??{},k=[s.dark??o.args.dark?"bg-dark p-4":"",s.stack?"stepper-variant-stack":""].filter(Boolean).join(" ");return b`
      ${y}
      <div class=${k}>${e()}</div>
    `}],r=(e,o=f)=>b`
  <it-stepper
