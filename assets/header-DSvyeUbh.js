import{j as e,M as d,C as n,a as t}from"./blocks-CiljGaP5.js";import{useMDXComponents as o}from"./index-dC3epPjb.js";import{H as c,a as l,S as h,b as p,c as m,d as u,e as x,f as j,g as r,h as g,i as v,j as b}from"./header.stories-E0eqoYBg.js";import"./preload-helper-PPVm8Dsz.js";import"./iframe-BIx49rSp.js";function s(a){const i={a:"a",code:"code",em:"em",h1:"h1",h2:"h2",h3:"h3",h4:"h4",li:"li",ol:"ol",p:"p",pre:"pre",strong:"strong",ul:"ul",...o(),...a.components};return e.jsxs(e.Fragment,{children:[e.jsx(d,{of:c}),`
...
`,e.jsxs(i.p,{children:["Quando la larghezza della viewport scende sotto il valore predefinito per l'attributo ",e.jsx(i.code,{children:"breakpoint"}),", ",e.jsx(i.code,{children:"<it-header>"})," passa dalla modalità inline a quella mobile. In automatico viene creata una modale laterale ",e.jsx(i.code,{children:"<it-modal>"}),", contenente una copia del menu di navigazione."]}),`
...
`,e.jsxs(i.ul,{children:[`
`,e.jsxs(i.li,{children:[e.jsx(i.code,{children:".it-brand-wrapper"})," nello slot ",e.jsx(i.code,{children:"header"})," della modale, se l'attributo ",e.jsx(i.code,{children:"hide-header-brand"})," non è attivo;"]}),`
`,e.jsxs(i.li,{children:[e.jsx(i.code,{children:".it-header-navbar-wrapper nav"})," che comprende:",`
`,e.jsxs(i.ul,{children:[`
`,e.jsx(i.li,{children:"menu principale"}),`
`,e.jsxs(i.li,{children:["menu secondario (se presente), a cui viene aggiunta la classe ",e.jsx(i.code,{children:".secondary"})]}),`
`]}),`
`]}),`
`,e.jsxs(i.li,{children:["la lista di collegamenti presente in  ",e.jsx(i.code,{children:".it-header-slim-wrapper ul"}),", a cui vengono aggiunte le classi ",e.jsx(i.code,{children:"secondary"})," e ",e.jsx(i.code,{children:"header-slim-menu"}),"."]}),`
...
`,e.jsx(i.li,{children:"Header della modale con il brand, se visibile."}),`
`,e.jsxs(i.li,{children:["Il contenuto della modale, nello slot ",e.jsx(i.code,{children:"content"}),"."]}),`
`,e.jsxs(i.li,{children:["All'interno del contenuto, ",e.jsx(i.code,{children:"nav.modal-nav"}),"."]}),`
`,e.jsxs(i.li,{children:["Dentro ",e.jsx(i.code,{children:"nav.modal-nav"}),", le liste della navbar nell'ordine originale e a seguire i collegamenti presenti nell'header slim."]}),`
`,e.jsx(i.li,{children:"La lista dei collegamenti social."}),`
`]}),`
