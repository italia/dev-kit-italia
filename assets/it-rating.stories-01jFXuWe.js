import{o as u,b as t}from"./iframe-BAOCzTeu.js";import{S as v}from"./formControlReusableStories-D7-t5ktS.js";const c={title:"Componenti/Rating",tags:["web-component","a11y-ok"],component:"it-rating",args:{name:"rating",value:0,disabled:!1,readOnly:!1,required:!1,icon:"it-star-outline",maxElements:5,form:"",customValidation:!1,validityMessage:""},argTypes:{name:{control:"text",description:"Nome del campo per l'invio del form"},value:{control:{type:"number",min:0,max:5,step:1},description:"Valore corrente della valutazione (0-5, 0 = nessuna stella selezionata)"},icon:{control:"text",description:"Nome dell'icona da utilizzare per gli item del rating",table:{defaultValue:{summary:"it-star-outline"}}},disabled:{control:"boolean",type:"boolean",description:"Se il rating è disabilitato",table:{defaultValue:{summary:"false"}}},readOnly:{name:"read-only",control:"boolean",type:"boolean",description:"Se il rating è in sola lettura (non interattivo)",table:{defaultValue:{summary:"false"}}},required:{control:"boolean",type:"boolean",description:"Se la selezione è obbligatoria",table:{defaultValue:{summary:"false"}}},maxElements:{name:"max-elements",control:{type:"number",min:1,step:1},description:"Numero massimo di elementi nel rating, per messaggi di supporto e accessibilità, modificare rispetto al default solo se si cambia il numero di elementi visualizzati rispetto al default di 5",table:{defaultValue:{summary:"5"}}},form:{control:"text",description:"ID html del form a cui è associato il componente it-radio-group, se non si trova all'interno di una form "},customValidation:{name:"custom-validation",control:"boolean",type:"boolean",table:{defaultValue:{summary:"false"}},description:"Se la validazione del radio group è fatta esternamente (lato server o con plugin js - validazione custom), impostare questo attributo a `true`."},validityMessage:{name:"validity-message",control:"text",description:"Messaggio da mostrare quando il radio group è invalido nel caso di validazione esterna (validazione custom). Se impostato a '' (stringa vuota) il campo viene considerato valido."}}},n={...c,name:"Esempio interattivo",tags:["!autodocs","!dev"],parameters:{docs:{canvas:{sourceState:"shown"}}},render:e=>t`
    <it-rating
      ...
      form="${u(e.form||void 0)}"
      ?custom-validation="${e.customValidation}"
      validity-message="${u(e.validityMessage||void 0)}"
    >
  ...
  \`
}`,...m.parameters?.docs?.source}}};p.parameters={...p.parameters,docs:{...p.parameters?.docs,source:{originalSource:"{\n  ...StoryFormControlMethodAndProps('', `|\\`click()\\`| Triggera l'evento di click sull'input reale | - |`),\n  tags: ['!dev']\n}",...p.parameters?.docs?.source}}};const b=["EsempioInterattivo","PersonalizzazioneDegliStili","ValorePreimpostato","SolaLettura","IconePersonalizzate","Obbligatorio","InForm","MetodiEPropPubblici"],h=Object.freeze(Object.defineProperty({__proto__:null,EsempioInterattivo:n,IconePersonalizzate:s,InForm:m,MetodiEPropPubblici:p,Obbligatorio:o,PersonalizzazioneDegliStili:i,SolaLettura:r,ValorePreimpostato:l,__namedExportsOrder:b,default:c},Symbol.toStringTag,{value:"Module"}));export{n as E,s as I,p as M,o as O,h as R,r as S,l as V,m as a};
