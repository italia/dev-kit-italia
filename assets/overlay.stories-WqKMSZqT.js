import{b as n}from"./iframe-C1Ia5SDB.js";const s={title:"Componenti/Overlay",tags:["documentation","a11y-ok"]},a={...s,name:"Overlay default",parameters:{docs:{description:{story:"\nIl colore predefinito dell’overlay corrisponde al colore `primary`.\n"}}},render:()=>n` <div class="container">
      <div class="row">
