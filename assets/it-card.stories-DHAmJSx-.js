import{b as a,o as i}from"./iframe-CGo9iNzD.js";const P=["default","inline","inline-reverse","inline-mini","inline-mini-reverse","profile","location","banner","inline-banner","inline-banner-reverse","inline-banner-mini","inline-banner-mini-reverse"],E=["primary","secondary","success","danger","warning"],V=["none","sm","md","lg"],N=["h1","h2","h3","h4","h5","h6"],L={title:"Componenti/Card",tags:["a11y-ok","web-component","alpha"],component:"it-card",parameters:{layout:"padded"},decorators:[e=>a` <div class="container p-0">${e()}</div> `],args:{fullHeight:!1},argTypes:{fullHeight:{name:"full-height",control:"boolean",description:"La card riempie l'altezza del contenitore padre",table:{defaultValue:{summary:"false"}}},variant:{control:"select",type:"string",options:P,description:"Variante di layout della card",table:{defaultValue:{summary:"default"}}},borderTop:{name:"border-top",control:"select",type:"string",options:E,description:"Aggiunge un bordo superiore colorato alla card per evidenziarla"},headingLevel:{name:"heading-level",control:"select",type:"string",options:N,description:'Livello di heading da usare per il titolo della card. Se non specificato, viene usato h3. Vedi la sezione "Accessibilità" della documentazione per maggiori dettagli.'},shadow:{control:"select",type:"string",options:V,description:"Modifica l'ombra della card."},border:{control:"select",type:"string",options:[void 0,"0"],description:"Imposta il valore 0 per rimuovere il bordo della card."},"actions-aria-label":{control:"text",type:"string",description:"Etichetta ARIA per il gruppo di azioni della card.",table:{defaultValue:{summary:"Link correlati:"}}},"it-class":{type:"string",description:"Aggiunge classi custom alla card generata. Utile per impostare padding custom all'interno della Card."}}};function t(e){return Object.keys(L.argTypes).reduce((D,I)=>(D[I]={table:{disable:!0}},D),{})}const o={name:"Esempio interattivo",tags:["!dev"],parameters:{docs:{canvas:{sourceState:"shown"}}},decorators:[e=>a`
      <div class="row">
  ...
  `},B={name:"Uso rispetto al contenitore (sperimentale)",argTypes:{...t()},parameters:{pageLayout:"w-100"},render:()=>a`
  ...
  `},A={name:"Confronto in colonne diverse",argTypes:{...t()},parameters:{pageLayout:"w-100"},render:()=>a`
    <div class="row">
