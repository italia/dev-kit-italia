...
</div>`}}},render:()=>(setTimeout(()=>{document.querySelectorAll("a.forward").forEach(i=>{const t=i.cloneNode(!0);i.parentNode?.replaceChild(t,i),t.addEventListener("click",a=>{a.preventDefault();const n=t.getAttribute("href"),o=document.querySelector(n);if(o){const s=window.matchMedia("(prefers-reduced-motion: reduce)").matches;o.scrollIntoView({behavior:s?"auto":"smooth",block:"start"})}})})},100),c`
...
}`,...e.parameters?.docs?.source}}};const d=["EsempioBase"],m=Object.freeze(Object.defineProperty({__proto__:null,EsempioBase:e,__namedExportsOrder:d,default:r},Symbol.toStringTag,{value:"Module"}));export{e as E,m as F};
