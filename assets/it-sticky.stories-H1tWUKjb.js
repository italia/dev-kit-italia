import{o as e,A as l,b as y}from"./iframe-DvG09N_F.js";function g({stackable:c,paddingTop:d,stickyClassName:p,positionType:m,position:u}){return y`
    <it-sticky
      ?stackable=${e(c)}
      padding-top=${e(d||l)}
      sticky-class-name=${e(p||l)}
      position-type=${e(m||l)}
      position=${e(u||l)}
    >
      <div class="bg-primary text-white p-3">Elemento Sticky</div>
    </it-sticky>
  `}const b={title:"Componenti/Sticky",component:"it-sticky",tags:["autodocs","a11y-ok","web-component"],args:{stackable:!1,paddingTop:0,stickyClassName:void 0,positionType:void 0,position:void 0},parameters:{docs:{description:{component:`<Description>Rende un elemento della pagina costantemente visibile allo scorrere della pagina.</Description>
...
È disponibile una <a href="iframe.html?globals=&id=esempi-sticky--padded-sticky&viewMode=story" target="_blank" rel="noopener">
  pagina di esempio
        ...
        `}}}},o={name:"Position fixed",parameters:{docs:{description:{story:`
...
È disponibile una <a href="iframe.html?globals=&id=esempi-sticky--fixed-sticky&viewMode=story" target="_blank" rel="noopener">
  ...
  <div class="bg-primary text-white p-3">Elemento Sticky</div>
</it-sticky>`}}}},a={name:"Classi personalizzate",args:{stickyClassName:"bg-light text-black"},parameters:{docs:{description:{story:`
...
\`\`\`
        `}}}},r={name:"Position fixed bottom",parameters:{docs:{description:{story:`
...
</it-sticky>`}}}};i.parameters={...i.parameters,docs:{...i.parameters?.docs,source:{originalSource:`{
...
}`,...r.parameters?.docs?.source}}};const k=["Base","TopOffset","Fixed","CustomClass","Stackable","CustomEvents","FixedBottom"],v=Object.freeze(Object.defineProperty({__proto__:null,Base:i,CustomClass:a,CustomEvents:s,Fixed:o,FixedBottom:r,Stackable:n,TopOffset:t,__namedExportsOrder:k,default:b},Symbol.toStringTag,{value:"Module"}));export{i as B,a as C,o as F,v as S,t as T,n as a,r as b};
