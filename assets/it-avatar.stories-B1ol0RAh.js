import{b as a,o as i,A as s}from"./iframe-P4qtb_wL.js";const f=["xs","sm","md","lg","xl","xxl"],b=["primary","secondary"],R=["image","text","icon"],M=["active","busy","hidden"],T=["approved","declined","notify"],e=t=>a`
  <it-avatar
    type="${i(t.type||s)}"
    size="${i(t.size||s)}"
...
\`
  ...
  \`
}`,...y.parameters?.docs?.source}}};const w=["EsempioInterattivo","PersonalizzazioneDegliStili","AvatarConImmagine","AvatarConTesto","AvatarConIcona","AvatarLink","ComportamentoPresenzaUtente","ComportamentoStatusUtente","GruppiAvatarListe","AvatarSovrapposti","AvatarSovrappostiSM","AvatarSovrappostiMD","AvatarConTestoAggiuntivo","GruppiAvatarConTesto"],$=Object.freeze(Object.defineProperty({__proto__:null,AvatarConIcona:p,AvatarConImmagine:o,AvatarConTesto:l,AvatarConTestoAggiuntivo:z,AvatarLink:c,AvatarSovrapposti:u,AvatarSovrappostiMD:x,AvatarSovrappostiSM:g,ComportamentoPresenzaUtente:d,ComportamentoStatusUtente:m,EsempioInterattivo:n,GruppiAvatarConTesto:y,GruppiAvatarListe:v,PersonalizzazioneDegliStili:r,__namedExportsOrder:w,default:h},Symbol.toStringTag,{value:"Module"}));export{$ as A,d as C,n as E,v as G,o as a,l as b,p as c,c as d,m as e,y as f,u as g,g as h,x as i,z as j};
