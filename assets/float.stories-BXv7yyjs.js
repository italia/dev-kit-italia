import{b as e}from"./iframe-Cl3Kz-XE.js";import{w as s}from"./organizzare-gli-spazi.helpers-C5Cchm54.js";const o={title:"Organizzare gli spazi/Float"},i={name:"Varianti start-end-none",tags:["!dev"],parameters:{pageLayout:"w-100",docs:{source:{code:`<div class="float-start">Esempio di float a sinistra per tutte le dimensioni</div><br />
<div class="float-end">Esempio di float a destra per tutte le dimensioni</div><br />
<div class="float-none">Float disattivo per tutte le dimensioni</div>`}}},render:()=>s(e`<div class="clearfix">
      ...
      </div>`)},a={name:"Varianti responsive",tags:["!dev"],parameters:{pageLayout:"w-100",docs:{source:{code:`<div class="float-sm-end">Esempio di float a destra per dimensioni SM (small) o maggiori.</div><br />
...
<div class="float-xxl-end">Esempio di float a destra per dimensioni XXL (extra-extra-large) o maggiori.</div>`}}},render:()=>s(e`<div class="clearfix">
...
<div class="float-none">Float disattivo per tutte le dimensioni</div>\`
  ...
  render: () => wrapExample(html\`<div class="clearfix">
        <div class="float-start">Esempio di float a sinistra per tutte le dimensioni</div>
        <div class="float-end">Esempio di float a destra per tutte le dimensioni</div>
        <div class="float-none">Float disattivo per tutte le dimensioni</div>
      </div>\`)
...
}`,...a.parameters?.docs?.source}}};const d=["VariantiStartEndNone","VariantiResponsive"],l=Object.freeze(Object.defineProperty({__proto__:null,VariantiResponsive:a,VariantiStartEndNone:i,__namedExportsOrder:d,default:o},Symbol.toStringTag,{value:"Module"}));export{l as S,i as V,a};
