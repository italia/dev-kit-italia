import{o as s,A as l,b as m}from"./iframe-DWFD1wCA.js";function u({stackable:r,paddingTop:c,stickyClassName:d,positionType:p}){return m`
    <it-sticky
      ?stackable=${s(r)}
      padding-top=${s(c||l)}
      sticky-class-name=${s(d||l)}
      position-type=${s(p||l)}
    >
      <div class="bg-primary text-white p-3">Elemento Sticky</div>
    </it-sticky>
  `}const y={title:"Componenti/Sticky",component:"it-sticky",tags:["autodocs","alpha","a11y-ok","web-component"],args:{stackable:!1,paddingTop:0,stickyClassName:void 0,positionType:void 0},parameters:{docs:{description:{component:`<Description>Rende un elemento della pagina costantemente visibile allo scorrere della pagina.</Description>
...
È disponibile una <a href="iframe.html?globals=&id=esempi-sticky--padded-sticky&viewMode=story" target="_blank" rel="noopener">
  pagina di esempio
        ...
        `}}}},t={name:"Position fixed",parameters:{docs:{description:{story:`
...
È disponibile una <a href="iframe.html?globals=&id=esempi-sticky--fixed-stick-classnamey&viewMode=story" target="_blank" rel="noopener">
  pagina di esempio
        ...
        `}}}},o={name:"Versione impilabile",args:{stackable:!0,paddingTop:0,stickyClassName:""},parameters:{docs:{description:{story:`
...
<br> Un'altra <a href="iframe.html?globals=&id=esempi-sticky--stackable-sticky-resize&viewMode=story" target="_blank" rel="noopener">
  pagina di esempio
        ...
        `}}}},n={name:"Eventi Custom",parameters:{viewMode:"docs",docs:{canvas:{hidden:!0,sourceState:"none"},description:{story:`
...
}`,...n.parameters?.docs?.source}}};const g=["Base","TopOffset","Fixed","CustomClass","Stackable","CustomEvents"],b=Object.freeze(Object.defineProperty({__proto__:null,Base:e,CustomClass:a,CustomEvents:n,Fixed:t,Stackable:o,TopOffset:i,__namedExportsOrder:g,default:y},Symbol.toStringTag,{value:"Module"}));export{e as B,a as C,t as F,b as S,i as T,o as a};
