import{b as r}from"./iframe-Cl3Kz-XE.js";import{w as s}from"./organizzare-gli-spazi.helpers-C5Cchm54.js";const t={title:"Organizzare gli spazi/Proporzioni"},a={name:"Esempio proporzione 16x9",tags:["!dev"],parameters:{pageLayout:"w-100",docs:{source:{code:`<div class="ratio ratio-16x9">
...
<div class="ratio ratio-21x9 ratio-example">
  <div>21x9</div>
        ...
        <div class="ratio ratio-21x9 ratio-example">
          <div>21x9</div>
        </div>`,{className:"ratio-examples"})},i={name:"Proporzione personalizzata",tags:["!dev"],parameters:{pageLayout:"w-100",docs:{source:{code:`<div class="ratio ratio-example" style="--bsi-aspect-ratio: 50%;">
  <div>2x1</div>
</div>`}}},render:()=>s(r`<div class="ratio ratio-example" style="--bsi-aspect-ratio: 50%;">
        <div>2x1</div>
...
<div class="ratio ratio-21x9 ratio-example">
  ...
  render: () => wrapExample(html\`<div class="ratio ratio-example" style="--bsi-aspect-ratio: 50%;">
        <div>2x1</div>
      </div>\`, {
    className: 'ratio-examples'
  })
