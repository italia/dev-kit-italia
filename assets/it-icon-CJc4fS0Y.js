import{E,f as v,u as b,i as g,b as A,x as R,a as I}from"./lit-element-DvQWNfDj.js";import{_ as t}from"./iframe-Bz4KNzwD.js";/**
 * @license
 ...
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const L={attribute:!0,type:String,converter:b,reflect:!1,hasChanged:v},T=(o=L,r,i)=>{const{kind:e,metadata:a}=i;let _=globalThis.litPropertyMetadata.get(a);if(_===void 0&&globalThis.litPropertyMetadata.set(a,_=new Map),e==="setter"&&((o=Object.create(o)).wrapped=!0),_.set(i.name,o),e==="accessor"){const{name:m}=i;return{set(p){const d=r.get.call(this);r.set.call(this,p),this.requestUpdate(m,d,o)},init(p){return p!==void 0&&this.C(m,void 0,o,p),p}}}if(e==="setter"){const{name:m}=i;return function(p){const d=this[m];r.call(this,p),this.requestUpdate(m,d,o)}}throw Error("Unsupported decorator location: "+e)};function n(o){return(r,i)=>typeof i=="object"?T(o,r,i):((e,a,_)=>{const m=a.hasOwnProperty(_);return a.constructor.createProperty(_,e),m?Object.getOwnPropertyDescriptor(a,_):void 0})(o,r,i)}/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 ...
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */function V(o,r){return(i,e,a)=>{const _=m=>{var p;return((p=m.renderRoot)==null?void 0:p.querySelector(o))??null};return P(i,e,{get(){return _(this)}})}}function l(o,r,i,e){var a=arguments.length,_=a<3?r:e,m;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")_=Reflect.decorate(o,r,i,e);else for(var p=o.length-1;p>=0;p--)(m=o[p])&&(_=(a<3?m(_):a>3?m(r,i,_):m(r,i))||_);return a>3&&_&&Object.defineProperty(r,i,_),_}function s(o,r){if(typeof Reflect=="object"&&typeof Reflect.metadata=="function")return Reflect.metadata(o,r)}/**
 * @license
 *
