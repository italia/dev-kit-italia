import{b as a,o as i,A as s}from"./iframe-BcvJloFY.js";const b=["xs","sm","md","lg","xl","xxl"],R=["primary","secondary"],T=["image","text","icon"],M=["active","busy","hidden"],w=["approved","declined","notify"],t=e=>a`
  <it-avatar
    type="${i(e.type||s)}"
    size="${i(e.size||s)}"
