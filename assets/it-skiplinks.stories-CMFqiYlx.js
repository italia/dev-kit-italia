import{b as t,o as l}from"./iframe-C0KgUC2J.js";const o=(e,r="")=>{const s=e.slot??r;return t`<it-skiplinks it-aria-label=${l(e["it-aria-label"])}> ${s} </it-skiplinks>`},n={title:"Componenti/Skiplinks",tags:["a11y-ok","web-component"],component:"it-skiplinks",args:{"it-aria-label":"Aria label"},argTypes:{"it-aria-label":{control:"text",description:"Testo aria-label del wrapper degli skiplinks."}},parameters:{docs:{description:{component:`
...
`}}}},a={...n,name:"Esempio",args:{"it-aria-label":"Vai a:"},parameters:{docs:{className:"my-wide-story",canvas:{sourceState:"shown"}}},render:e=>t` ${o({...e,slot:t`<a href="#menu">Vai al menu</a>
...
}`,...i.parameters?.docs?.source}}};const c=["EsempioInterattivo","PochiLink"],m=Object.freeze(Object.defineProperty({__proto__:null,EsempioInterattivo:a,PochiLink:i,__namedExportsOrder:c,default:n},Symbol.toStringTag,{value:"Module"}));export{a as E,i as P,m as S};
