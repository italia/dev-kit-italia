import{b as o}from"./iframe-CGo9iNzD.js";import{w as t}from"./organizzare-gli-spazi.helpers-CkzUsuDU.js";const n={title:"Organizzare gli spazi/Bordi"},a={name:"Aggiuntivo",tags:["!dev"],parameters:{pageLayout:"w-100",docs:{source:{code:`<span class="border"></span>
<span class="border-top"></span>
<span class="border-end"></span>
<span class="border-bottom"></span>
<span class="border-start"></span>`}}},render:()=>t(o`<span class="border"></span>
        <span class="border-top"></span>
        <span class="border-end"></span>
        <span class="border-bottom"></span>
        <span class="border-start"></span>`,{className:"bd-example-border-utils"})},e={name:"Sottrattivo",tags:["!dev"],parameters:{pageLayout:"w-100",docs:{source:{code:`<span class="border-0"></span>
<span class="border-top-0"></span>
<span class="border-end-0"></span>
<span class="border-bottom-0"></span>
<span class="border-start-0"></span>`}}},render:()=>t(o`<span class="border-0"></span>
        <span class="border-top-0"></span>
        <span class="border-end-0"></span>
        <span class="border-bottom-0"></span>
        <span class="border-start-0"></span>`,{className:"bd-example-border-utils bd-example-border-utils-0"})},s={name:"Varianti di colore",tags:["!dev"],parameters:{pageLayout:"w-100",docs:{source:{code:`<span class="border border-primary"></span>
<span class="border border-secondary"></span>
<span class="border border-success"></span>
<span class="border border-danger"></span>
<span class="border border-warning"></span>
<span class="border border-white"></span>`}}},render:()=>t(o`<span class="border border-primary"></span>
        <span class="border border-secondary"></span>
        <span class="border border-success"></span>
        <span class="border border-danger"></span>
        <span class="border border-warning"></span>
        <span class="border border-white"></span>`,{className:"bd-example-border-utils"})},r={name:"Arrotondati",tags:["!dev"],parameters:{pageLayout:"w-100",docs:{source:{code:`<img src="https://placehold.co/75x75/ebebeb/808080/?text=Immagine" class="rounded" alt="Esempio di immagine arrotondata">
  ...
  <img src="https://placehold.co/150x75/ebebeb/808080/?text=Immagine" class="rounded-pill" alt="Esempio di immagine arrotondata a pillola">`}}},render:()=>t(o`<img
...
<span class="border-start"></span>\`
  ...
  render: () => wrapExample(html\`<span class="border"></span>
        <span class="border-top"></span>
        <span class="border-end"></span>
        <span class="border-bottom"></span>
        <span class="border-start"></span>\`, {
...
<span class="border-start-0"></span>\`
  ...
  render: () => wrapExample(html\`<span class="border-0"></span>
        <span class="border-top-0"></span>
        <span class="border-end-0"></span>
        <span class="border-bottom-0"></span>
        <span class="border-start-0"></span>\`, {
...
<span class="border border-white"></span>\`
  ...
  render: () => wrapExample(html\`<span class="border border-primary"></span>
        <span class="border border-secondary"></span>
        <span class="border border-success"></span>
        <span class="border border-danger"></span>
        <span class="border border-warning"></span>
  ...
  render: () => wrapExample(html\`<img
        ...
        <img
          ...
          alt="Esempio di immagine arrotondata a pillola"
        />\`)
}`,...r.parameters?.docs?.source}}};const d=["Aggiuntivo","Sottrattivo","VariantiDiColore","Arrotondati"],c=Object.freeze(Object.defineProperty({__proto__:null,Aggiuntivo:a,Arrotondati:r,Sottrattivo:e,VariantiDiColore:s,__namedExportsOrder:d,default:n},Symbol.toStringTag,{value:"Module"}));export{a as A,c as S,s as V,e as a,r as b};
