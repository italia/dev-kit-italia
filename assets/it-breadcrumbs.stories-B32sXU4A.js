...
.breadcrumb-item.active ::slotted(*) {
  ...
  text-decoration: none !important;
    ...
    `:b`
      ...
      `}};f.styles=K;s([I(),n("design:type",Object)],f.prototype,"current",void 0);s([I(),n("design:type",Object)],f.prototype,"separator",void 0);f=s([_("it-breadcrumb-item")],f);var X=M`/***************************** 1 ****************************************/
/***************************** 2 ****************************************/
/***************************** 1 ****************************************/
/***************************** 2 ****************************************/
/***************************** 1 ****************************************/
...
}`;let g=class extends F{constructor(){super(...arguments),this.itAriaLabel="Breadcrumbs",this.separator="/",this.dark=!1}_setChildrenProperties(){const r=this.shadowRoot?.querySelector("slot")?.assignedElements({flatten:!0})||[];r.forEach((t,i)=>{if(t instanceof f){const o=i===r.length-1;t.setCurrent(o),t.setSeparator(this.separator)}})}render(){const e=this.dark?"breadcrumb dark":"breadcrumb";return b`
