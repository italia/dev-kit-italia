import{j as i,M as l}from"./blocks-DGm5YkTy.js";import{useMDXComponents as s}from"./index-DbevRHTU.js";import"./preload-helper-PPVm8Dsz.js";import"./iframe-Ug63oIzY.js";function r(e){const n={a:"a",code:"code",h1:"h1",h2:"h2",h3:"h3",li:"li",p:"p",pre:"pre",strong:"strong",ul:"ul",...s(),...e.components};return i.jsxs(i.Fragment,{children:[i.jsx(l,{title:"Documentazione tecnica"}),`
...
`,i.jsxs("it-callout",{variant:"primary","heading-level":"h3",children:[i.jsx("span",{slot:"title",children:"NOTA"}),i.jsxs("p",{children:["Per il comportamento del kit in ambienti con Server-Side Rendering (Next.js, SvelteKit, Nuxt, Angular SSR) e i pattern di importazione da usare in quei contesti, vedi la guida dedicata a ",i.jsx(n.a,{href:"/docs/framework-ssr--documentazione",children:"SSR"}),"."]})]}),`
