import{b as a}from"./iframe-B_tBykbp.js";const r={breakpoint:991,openAriaLabel:"Mostra la navigazione",closeAriaLabel:"Chiudi la navigazione",modalAriaLabel:"Navigazione del sito",hideHeaderBrand:!1,modalHeaderTheme:void 0},H={title:"Componenti/Header",tags:["web-component","a11y-ok"],parameters:{pageLayout:"w-100"},argTypes:{breakpoint:{control:{type:"number"},description:"Larghezza in pixel sotto la quale si attiva la modalita mobile.",table:{defaultValue:{summary:"991"}}},openAriaLabel:{name:"open-aria-label",control:{type:"text"},description:"Etichetta ARIA del pulsante che apre la navigazione mobile.",table:{defaultValue:{summary:"Mostra la navigazione"}}},closeAriaLabel:{name:"close-aria-label",control:{type:"text"},description:"Etichetta ARIA del pulsante che chiude la navigazione mobile.",table:{defaultValue:{summary:"Chiudi la navigazione"}}},modalAriaLabel:{name:"modal-aria-label",control:{type:"text"},description:"Etichetta ARIA della modale usata per la navigazione mobile.",table:{defaultValue:{summary:"Navigazione del sito"}}},hideHeaderBrand:{name:"hide-header-brand",control:{type:"boolean"},description:"Nasconde la fascia contente il brand, nell header della modale del menu su mobile.",table:{defaultValue:{summary:"false"}}},modalHeaderTheme:{name:"modal-header-theme",control:{type:"select"},options:["dark","light"],description:"Tema del background dell'header della modale mobile. Se non valorizzato, usa il tema di default usato nell'Header Center.",table:{defaultValue:{summary:"default (auto)"}}}}},h=({accessButton:e="default",theme:b="default"}={})=>{let f=a`<it-button variant="primary" size="xs">Accedi</it-button>`;return e==="full"&&(f=a` <a
      href="#"
    ...
    </a>`),a` <div class="it-header-slim-wrapper${b==="light"?" theme-light":""}">
  ...
  </div>`},i={render:()=>h()},n={name:"Slim Header con Pulsante full-responsive",render:()=>h({accessButton:"full"})},t={name:"Slim Header - Versione chiara",render:()=>h({theme:"light"})},u=({theme:e="default",compact:b=!1}={})=>a` <div
    class="it-header-center-wrapper${e==="light"?" theme-light":""}${b?" it-small-header":""} "
  >
    <div class="container-xxl">
      <div class="row">
        <div class="col-12">
  ...
  </div>`,l={name:"Header Centrale",render:()=>u({})},s={name:"Header Centrale - Versione compatta",render:()=>u({compact:!0})},d={name:"Header Centrale - Versione chiara",render:()=>u({theme:"light"})},g=({wrapperClassName:e=""}={})=>a`<div class="it-header-navbar-wrapper ${e}">
    <div class="container-xxl">
      <div class="row">
        <div class="col-12">
          <!--start nav-->
  ...
  </div>`,o={render:()=>g()},c={name:"Header Nav - Versione chiara",render:()=>g({wrapperClassName:"theme-light"})},m={name:"Header Nav con Navigazione secondaria",render:()=>a`<div class="it-header-navbar-wrapper">
      <div class="container-xxl">
        <div class="row">
          <div class="col-12">
            <!--start nav-->
    ...
    </div>`},p={name:"Header completo",args:r,parameters:{layout:"fullscreen",pageLayout:"header-full"},render:e=>a`<it-header
    ...
    >
      <header class="it-header-wrapper">${h()} ${u()}${g()}</header>
    </it-header>`},v={name:"Header completo - Versione chiara",args:r,parameters:{layout:"fullscreen",pageLayout:"header-full"},render:()=>a`<it-header
    ...
    >
      <header class="it-header-wrapper it-shadow">
        ${h({theme:"light"})}
        ${u({theme:"light"})}${g({wrapperClassName:"theme-light"})}
      </header>
...
}`,...v.parameters?.docs?.source}}};const w=["SlimHeader","SlimHeaderActionFull","SlimHeaderLight","HeaderCenter","HeaderCenterCompact","HeaderCenterLight","HeaderNav","HeaderNavDesktopLight","HeaderNavSecondary","HeaderFull","HeaderFullLight"],L=Object.freeze(Object.defineProperty({__proto__:null,HeaderCenter:l,HeaderCenterCompact:s,HeaderCenterLight:d,HeaderFull:p,HeaderFullLight:v,HeaderNav:o,HeaderNavDesktopLight:c,HeaderNavSecondary:m,SlimHeader:i,SlimHeaderActionFull:n,SlimHeaderLight:t,__namedExportsOrder:w,default:H},Symbol.toStringTag,{value:"Module"}));export{L as H,i as S,p as a,n as b,t as c,l as d,s as e,d as f,o as g,c as h,m as i,v as j};
