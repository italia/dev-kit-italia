...
`]}),`
`,e.jsxs(n.p,{children:["Un vero SSR con Declarative Shadow DOM, dove il markup interno dei componenti è generato dal server, è tecnicamente ottenibile attraverso l'uso della libreria ",e.jsx(n.a,{href:"https://www.npmjs.com/package/@lit-labs/ssr",rel:"nofollow",children:"@lit-labs/ssr"}),"."]}),`
`,e.jsxs(n.p,{children:["Trattandosi di una ",e.jsx(n.strong,{children:"libreria sperimentale"}),", il suo uso ",e.jsx(n.strong,{children:"non è consigliato in ambienti di produzione"}),"."]}),`
