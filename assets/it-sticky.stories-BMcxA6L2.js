import{o as e,A as l,b as m}from"./iframe-DREyQnEe.js";import"./preload-helper-PPVm8Dsz.js";function u({stackable:r,paddingTop:c,stickyClassName:d,positionType:p}){return m`
    <it-sticky
      ?stackable=${e(r)}
      padding-top=${e(c||l)}
      sticky-class-name=${e(d||l)}
      position-type=${e(p||l)}
    >
      <div class="bg-primary text-white p-3">Elemento Sticky</div>
    </it-sticky>
  `}const k={title:"Componenti/Sticky",component:"it-sticky",tags:["autodocs","alpha","a11y-ok","web-component"],args:{stackable:!1,paddingTop:0,stickyClassName:void 0,positionType:void 0},parameters:{docs:{description:{component:`<Description>Rende un elemento della pagina costantemente visibile allo scorrere della pagina.</Description>
...
}`,...s.parameters?.docs?.source}}};const b=["Base","TopOffset","Fixed","CustomClass","Stackable","CustomEvents"];export{i as Base,o as CustomClass,s as CustomEvents,a as Fixed,n as Stackable,t as TopOffset,b as __namedExportsOrder,k as default};
