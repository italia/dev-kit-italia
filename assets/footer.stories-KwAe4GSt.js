import{b as s}from"./iframe-CbN6PWjR.js";const a=s`
...
</footer>`,o={title:"Componenti/Footer",component:"footer",tags:["documentation","a11y-ok"]},i={tags:["!autodocs","!dev"],parameters:{canvas:{hidden:!0,sourceState:"none"},viewMode:"docs",docs:{page:null}}},e={render:()=>s`${a}`,name:"Footer completo",parameters:{docs:{description:{story:`Nel footer completo sono presenti i seguenti elementi:
...
- **Iscrizione Newsletter** (opzionale).`}}}},l={render:()=>s`${t}`,name:"Footer compatto",parameters:{docs:{description:{story:`Il footer compatto è una versione semplificata del footer completo.
...
}`,...l.parameters?.docs?.source}}};const n=["Placeholder","FooterCompleto","FooterCompatto"],r=Object.freeze(Object.defineProperty({__proto__:null,FooterCompatto:l,FooterCompleto:e,Placeholder:i,__namedExportsOrder:n,default:o},Symbol.toStringTag,{value:"Module"}));export{r as F,e as a,l as b};
