import{j as e,M as l,T as t,C as n,a as c}from"./blocks-BwN-HPQk.js";import{useMDXComponents as r}from"./index-BLyyUXyz.js";import{S as d,E as o,D as p,a as h,M as u,b as x,P as j,c as m}from"./it-navscroll.stories-DR2Cs5dK.js";import"./preload-helper-PPVm8Dsz.js";import"./iframe-B_tBykbp.js";function s(a){const i={a:"a",code:"code",h2:"h2",h3:"h3",li:"li",p:"p",pre:"pre",strong:"strong",ul:"ul",...r(),...a.components};return e.jsxs(e.Fragment,{children:[e.jsx(l,{of:d}),`
`,e.jsx(t,{}),`
`,e.jsx("description",{children:e.jsx(i.p,{children:"Lista di link con ancore per navigare velocemente a una sezione specifica della pagina in cui è contenuto."})}),`
...
`,e.jsxs(i.p,{children:["Per mostrare la barra di progresso, aggiungi il componente ",e.jsx(i.code,{children:"<it-progress>"})," all'interno del ",e.jsx(i.code,{children:"<div>"})," con classe ",e.jsx(i.code,{children:".link-list-wrapper"}),", assegnandogli la classe ",e.jsx(i.code,{children:".it-navscroll-progressbar"}),"."]}),`
...
`]}),`
`,e.jsx(n,{of:m})]})}function P(a={}){const{wrapper:i}={...r(),...a.components};return i?e.jsx(i,{...a,children:e.jsx(s,{...a})}):s(a)}export{P as default};
