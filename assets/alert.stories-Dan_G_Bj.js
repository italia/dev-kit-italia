import{b as r}from"./iframe-DO9HwPeR.js";const l={title:"Componenti/Alert",tags:["alpha","a11y-ok","documentation"],parameters:{layout:"padded",docs:{source:{excludeDecorators:!0}}}},e={decorators:[n=>r`<div style="display:flex;flex-direction:column;gap:1rem">${n()}</div>`],render:()=>r`
