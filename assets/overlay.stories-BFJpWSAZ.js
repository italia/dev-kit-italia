import{b as n}from"./iframe-90FZwcPR.js";const s={title:"Componenti/Overlay",tags:["documentation","alpha","a11y-ok"]},a={...s,name:"Overlay default",parameters:{docs:{description:{story:"\nIl colore predefinito dell’Overlay corrisponde al colore `primary`.\n"}}},render:()=>n` <div class="container">
      <div class="row">
