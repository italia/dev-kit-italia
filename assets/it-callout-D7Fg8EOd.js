import{j as e,M as s,C as n,a}from"./blocks-CToh_lwI.js";import{useMDXComponents as r}from"./index-Bhsl1YDk.js";import{C as c,E as o,a as d,b as h,c as p,d as u,e as x,H as j,f as m,g,h as f,i as z,j as b}from"./it-callout.stories-BzQzVr8T.js";import"./preload-helper-PPVm8Dsz.js";import"./iframe-Cl3Kz-XE.js";function t(l){const i={a:"a",code:"code",h1:"h1",h2:"h2",h3:"h3",h4:"h4",li:"li",p:"p",strong:"strong",ul:"ul",...r(),...l.components};return e.jsxs(e.Fragment,{children:[e.jsx(s,{of:c}),`
...
`,e.jsxs(i.ul,{children:[`
`,e.jsxs(i.li,{children:[e.jsx(i.code,{children:"--#${prefix}callout-text-size"}),", per la dimensione del font dei paragrafi (default: ",e.jsx(i.code,{children:"16px"}),", con ",e.jsx(i.code,{children:"big-text"}),": ",e.jsx(i.code,{children:"18px"}),");"]}),`
`,e.jsxs(i.li,{children:[e.jsx(i.code,{children:"--#${prefix}callout-font-family"}),", per la famiglia di font del testo (default: font serif di Bootstrap Italia)."]}),`
`]}),`
