import{b as s,o as t}from"./iframe-BIx49rSp.js";const d=["top","bottom"],g=[null,"left","right"],v=[null,"mobile","desktop","always"],b=(e,a=!0)=>s`<div class="link-list-wrapper">
    <h3>Header</h3>
    ${a?s`
  ...
  </div>`,r=e=>{const a=e._uniqueStoryID??"";return s`
    <div class="row row-column-border border-light row-column-menu-left bg-white">
      <aside class="col-lg-4 ${e["line-position"]==="left"?"order-2":""}" aria-label="Indice della pagina">
        <it-navscroll
          ...
          dark-mode=${t(e["dark-mode"])}
          position=${t(e.position)}
          line-position=${t(e["line-position"])}
          breakpoint="${t(e.breakpoint)}"
          open-label=${t(e["open-label"])}
          open-aria-label=${t(e["open-aria-label"])}
          back-label=${t(e["back-label"])}
        >
          ${b(a,e._progress)}
        </it-navscroll>
      </aside>
  ...
  `},i={title:"Componenti/Navscroll",tags:["web-component","a11y-ok"],component:"it-navscroll",args:{for:"#scroll-container",position:void 0,sticky:void 0,"line-position":void 0,"dark-mode":void 0,breakpoint:void 0,"open-label":void 0,"open-aria-label":void 0,"back-label":void 0},argTypes:{for:{control:"text",description:"Selettore del contenitore scrollabile da monitorare per determinare l'elemento attivo corrente ed eventualmente aggioranre la progress bar. Se non definito, viene usato document.scrollingElement"},position:{control:"select",description:"Posizione dello navscroll su mobile quando è chiuso",options:d,type:"string",table:{defaultValue:{summary:"bottom"}}},sticky:{control:"boolean",type:"boolean",description:"Quando abilitato, il nav viene fissato in alto durante lo scroll della pagina (su desktop)",table:{defaultValue:{summary:"false"}}},"line-position":{control:"select",description:"Posizione della linea laterale su desktop",type:"string",options:g},"dark-mode":{control:"select",description:'Quando mostrare la modalità "dark"',type:"string",options:v},breakpoint:{control:"number",description:"Breakpoint sotto il quale la navigazione viene collassata",type:"number",table:{defaultValue:{summary:"991"}}},"open-label":{control:"text",description:"Etichetta per l'apertura del menu collassato su mobile, quando nessuna sezione è ancora attiva",type:"string",table:{defaultValue:{summary:"Indice di navigazione"}}},"open-aria-label":{control:"text",description:"aria-label per il menu collassato su mobile",type:"string",table:{defaultValue:{summary:"Apri/Chiudi indice di navigazione"}}},"back-label":{control:"text",description:"Testo da mostrare sul pulsante di chiusura del menu su mobile",type:"string",table:{defaultValue:{summary:"Indietro"}}}},parameters:{docs:{canvas:{sourceState:"hidden"},description:{component:`
...
`}}}},n={...i,name:"Esempio",args:{},render:e=>s` ${r({...e,_uniqueStoryID:"-story1"})}`},o={...i,name:"Posizionata a sinistra su desktop",args:{"line-position":"right"},render:e=>s` ${r({...e,_progress:!1,_uniqueStoryID:"-story2-1"})}`},u={...i,name:"Posizionata a destra su desktop",args:{"line-position":"left"},render:e=>s` ${r({...e,_progress:!1,_uniqueStoryID:"-story2-2"})}`},l={...i,name:"Posizionata a fondo pagina",args:{position:"bottom"},render:e=>s` ${r({...e,_progress:!1,_uniqueStoryID:"-story3-1"})}`},m={...i,name:"Posizionata in testa alla pagina",args:{position:"top"},render:e=>s` ${r({...e,_progress:!1,_uniqueStoryID:"-story3-2"})}`},c={...i,name:"Con barra di progresso",render:e=>s` ${r({...e,_uniqueStoryID:"-story4"})}`},p={...i,name:"Variante scura",render:e=>s` ${r({...e,"dark-mode":"always",_progress:!1,_uniqueStoryID:"-story5"})}`};n.parameters={...n.parameters,docs:{...n.parameters?.docs,source:{originalSource:`{
  ...meta,
  name: 'Esempio',
  args: {},
...
}`,...p.parameters?.docs?.source}}};const q=["EsempioInterattivo","DesktopOnLeft","DesktopOnRight","MobileBottom","MobileTop","Progress","DarkModeStory"],h=Object.freeze(Object.defineProperty({__proto__:null,DarkModeStory:p,DesktopOnLeft:o,DesktopOnRight:u,EsempioInterattivo:n,MobileBottom:l,MobileTop:m,Progress:c,__namedExportsOrder:q,default:i},Symbol.toStringTag,{value:"Module"}));export{o as D,n as E,l as M,c as P,h as S,u as a,m as b,p as c};
