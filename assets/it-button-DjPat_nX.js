import{i as f,x as m,a as x}from"./lit-element-DvQWNfDj.js";import{e as k,n as c,o as d,t as w}from"./query-nkdlPDuA.js";/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const N={CHILD:2},E=r=>(...t)=>({_$litDirective$:r,values:t});class ${constructor(t){}get _$AU(){return this._$AM._$AU}_$AT(t,e,n){this._$Ct=t,this._$AM=e,this._$Ci=n}_$AS(t,e){return this.update(t,e)}update(t,e){return this.render(...e)}}function s(r,t,e,n){var a=arguments.length,i=a<3?t:n,l;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")i=Reflect.decorate(r,t,e,n);else for(var v=r.length-1;v>=0;v--)(l=r[v])&&(i=(a<3?l(i):a>3?l(t,e,i):l(t,e))||i);return a>3&&i&&Object.defineProperty(t,e,i),i}function b(r,t){if(typeof Reflect=="object"&&typeof Reflect.metadata=="function")return Reflect.metadata(r,t)}/**
 * @license
 *
...
}`;let o=class extends A{constructor(){super(...arguments),this.type="button",this.variant="",this.size="",this.outline=!1,this.block=!1,this.icon=!1,this.value="",this.internals=this.attachInternals(),this._onKeyDown=t=>{var e;(t.key==="Enter"||t.key===" ")&&(t.preventDefault(),(e=this._nativeButton)==null||e.click())}}static get formAssociated(){return!0}surfaceSubmitEvent(t){this.form&&!this.disabled&&(t.preventDefault(),t.stopPropagation(),this.form.requestSubmit()),this.disabled&&(t.preventDefault(),t.stopPropagation())}get form(){return this.internals?this.internals.form:null}focus(){var t;(t=this._nativeButton)==null||t.focus()}connectedCallback(){var t;(t=super.connectedCallback)==null||t.call(this),this.block&&this.classList.add("d-block","w-100"),this.addEventListener("keydown",this._onKeyDown)}disconnectedCallback(){var t;this.removeEventListener("keydown",this._onKeyDown),(t=super.disconnectedCallback)==null||t.call(this)}render(){var n;const t=this.composeClass("btn",this.className,{[`btn-${this.variant}`]:!!this.variant&&!this.outline,[`btn-outline-${this.variant}`]:!!this.variant&&this.outline,[`btn-${this.size}`]:!!this.size,disabled:this.disabled,"btn-icon":this.icon,"d-block w-100":this.block}),e=this.composeClass("button","focusable",{[this.variant]:((n=this.variant)==null?void 0:n.length)>0,outline:this.outline});return m`
      <button
        id=${d(this.id||void 0)}
        part="${e}"
        type="${this.type}"
