import{j as e,M as t}from"./blocks-Byz_BPrk.js";import{useMDXComponents as l}from"./index-DY0hxXWi.js";import"./preload-helper-PPVm8Dsz.js";import"./iframe-BcuqimjD.js";function a(n){const i={a:"a",code:"code",h2:"h2",h3:"h3",h4:"h4",li:"li",ol:"ol",p:"p",pre:"pre",strong:"strong",ul:"ul",...l(),...n.components};return e.jsxs(e.Fragment,{children:[e.jsx(t,{title:"Introduzione"}),`
`,e.jsxs("div",{className:"mb-4",children:[e.jsx("h1",{className:"visually-hidden",children:"Dev Kit Italia"}),e.jsx("div",{children:e.jsx("img",{src:"./logo.png",width:"500px",alt:".italia dev kit"})}),e.jsxs("p",{className:"lead mb-5",children:["Dev Kit Italia è un set di Web components che implementa il Design system .italia e i componenti presenti su ",e.jsx(i.a,{href:"https://github.com/italia/design-ui-kit",rel:"nofollow",children:`UI Kit
Italia`}),"."]}),e.jsx("p",{className:"lead mb-5",children:e.jsxs("b",{children:["⚠️ Attenzione: questo repository e i relativi pacchetti sono in lavorazione.",e.jsx("br",{}),`Attualmente sono pubblicati per permetterne lo sviluppo, non sono consigliati per l'utilizzo in ambienti di
produzione.`]})})]}),`
`,e.jsx(i.h2,{id:"il-progetto",children:"Il progetto"}),`
`,e.jsxs(i.p,{children:["Dev Kit Italia è un progetto open source che raccoglie strumenti, componenti e risorse per sviluppare interfacce coerenti con il Design System ",e.jsx(i.strong,{children:".italia"}),"."]}),`
`,e.jsx(i.h3,{id:"obiettivo",children:"Obiettivo"}),`
`,e.jsx(i.p,{children:"Il suo obiettivo è semplificare la creazione di siti e applicazioni della Pubblica Amministrazione, offrendo componenti pronti all’uso, con documentazione chiara e linee guida condivise."}),`
`,e.jsxs(i.p,{children:["Il progetto nasce per evolvere le attuali librerie di sviluppo (come Bootstrap Italia, React Kit e Angular Kit) verso un sistema basato su ",e.jsx(i.strong,{children:"web component"}),` nativi HTML, più flessibile, duraturo e indipendente dai framework.
Questo approccio permette di:`]}),`
`,e.jsxs(i.ul,{children:[`
`,e.jsxs(i.li,{children:["usare gli stessi componenti in ",e.jsx(i.strong,{children:"qualsiasi ambiente"})," di sviluppo;"]}),`
`,e.jsxs(i.li,{children:[e.jsx(i.strong,{children:"ridurre"})," la manutenzione del codice e il ",e.jsx(i.strong,{children:"debito tecnico"}),";"]}),`
`,e.jsxs(i.li,{children:["garantire ",e.jsx(i.strong,{children:"accessibilità"})," (WCAG 2.2) e uniformità visiva;"]}),`
`,e.jsxs(i.li,{children:["facilitare la ",e.jsx(i.strong,{children:"personalizzazione"})," tramite design token integrati."]}),`
`]}),`
`,e.jsx(i.p,{children:"In sintesi, Dev Kit Italia punta a rendere più facile e sostenibile lo sviluppo di siti e servizi pubblici digitali, offrendo strumenti moderni e aperti a chiunque voglia contribuire o creare esperienze utente di qualità."}),`
...
`]}),`
`,e.jsx(i.pre,{children:e.jsx(i.code,{className:"language-bash",children:`pnpm install # Per installare tutte le dipendeze dei vari packages
pnpm build
`})}),`
...
`]}),`
`,e.jsx(i.pre,{children:e.jsx(i.code,{className:"language-bash",children:`cd examples/react-app
npm install # Per copiare nella node_modules la versione compilata di dev-kit-italia
npm run dev
`})}),`
`,e.jsx(i.p,{children:"Se invece si vuole testare l'app Angular, è necessario fare:"}),`
`,e.jsx(i.pre,{children:e.jsx(i.code,{className:"language-bash",children:`cd examples/angular-app
npm install # Per copiare nella node_modules la versione compilata di dev-kit-italia
npm start
`})})]})}function d(n={}){const{wrapper:i}={...l(),...n.components};return i?e.jsx(i,{...n,children:e.jsx(a,{...n})}):a(n)}export{d as default};
