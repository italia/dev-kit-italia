import{b,o as a}from"./iframe-Ug63oIzY.js";const h=["text","icons","numbers"],x=["bar","dots",""],f=[{label:"Primo contenuto",icon:"it-calendar"},{label:"Secondo contenuto",icon:"it-lock"},{label:"Terzo contenuto",icon:"it-settings"}],E=b`
  <style>
