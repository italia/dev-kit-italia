import{b as o,o as n}from"./iframe-B_tBykbp.js";const I=["text","icons","numbers"],D=["bar","dots",""],$=[{label:"Primo contenuto",icon:"it-calendar"},{label:"Secondo contenuto",icon:"it-lock"},{label:"Terzo contenuto",icon:"it-settings"}],q=o`
  <style>
