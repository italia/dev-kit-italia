import{j as e,M as r}from"./blocks-BOPJQLxO.js";import{useMDXComponents as l}from"./index-B0YyzAz0.js";import"./preload-helper-PPVm8Dsz.js";import"./iframe-C2GQMFKp.js";function a(i){const n={a:"a",code:"code",h1:"h1",h2:"h2",h3:"h3",li:"li",ol:"ol",p:"p",pre:"pre",strong:"strong",ul:"ul",...l(),...i.components};return e.jsxs(e.Fragment,{children:[e.jsx(r,{title:"Come contribuire"}),`
...
`})}),`
`,e.jsx(n.p,{children:`Come alternativa, è possibile installare i singoli pacchetti dei Web Components.
Sarà comunque necessario importare il file CSS generale come mostrato sopra.`}),`
`,e.jsx(n.pre,{children:e.jsx(n.code,{className:"language-bash",children:`npm install @italia/button @italia/dev-kit-italia
`})}),`
`,e.jsx(n.pre,{children:e.jsx(n.code,{className:"language-javascript",children:`import '@italia/dev-kit-italia/fonts.css';
import '@italia/dev-kit-italia/styles.css';
...
npm install # Per copiare nella node_modules la versione compilata di dev-kit-italia
npm start
`})})]})}function d(i={}){const{wrapper:n}={...l(),...i.components};return n?e.jsx(n,{...i,children:e.jsx(a,{...i})}):a(i)}export{d as default};
