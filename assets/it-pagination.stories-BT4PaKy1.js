import{b as n,o as u}from"./iframe-DswZOSx7.js";const y=["start","center","end"];var v=Object.freeze,x=Object.defineProperty,P=(a,i)=>v(x(a,"raw",{value:v(a.slice())})),f,b;const S=a=>n`
...
`,T=[{page:"1",label:"1"},{page:"2",label:"2"},{page:"3",label:"3"},{page:"4",label:"4"},{page:"5",label:"5"}],N={title:"Componenti/Pagination",tags:["a11y-ok","web-component","new"],decorators:[(a,i)=>i.parameters.overrideMetaWrapper?a():n`
