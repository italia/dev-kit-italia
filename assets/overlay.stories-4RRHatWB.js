import{b as n}from"./iframe-taocDA-g.js";const s={title:"Componenti/Overlay",tags:["documentation","a11y-ok"]},a={...s,name:"Overlay default",parameters:{docs:{description:{story:"\nIl colore predefinito dell’overlay corrisponde al colore `primary`.\n"}}},render:()=>n` <div class="container">
      <div class="row">
