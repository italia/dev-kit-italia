import{b as r}from"./iframe-DWFD1wCA.js";const l={title:"Componenti/Alert",tags:["alpha","a11y-ok","documentation"],parameters:{layout:"padded"}},e={decorators:[n=>r`<div style="display:flex;flex-direction:column;gap:1rem">${n()}</div>`],render:()=>r`
