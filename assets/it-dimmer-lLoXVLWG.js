import{j as e,M as t,T as d,C as n,a as c}from"./blocks-dx3NoGiK.js";import{useMDXComponents as a}from"./index-DzLslUGg.js";import{S as r,E as s,C as m,a as h,b as p,c as u,d as j,A as x,e as v}from"./it-dimmer.stories-S1RkhBYs.js";import"./preload-helper-PPVm8Dsz.js";import"./iframe-Mb8pSUIi.js";function l(o){const i={a:"a",code:"code",h2:"h2",h3:"h3",li:"li",p:"p",pre:"pre",strong:"strong",ul:"ul",...a(),...o.components};return e.jsxs(e.Fragment,{children:[e.jsx(t,{of:r}),`
`,e.jsx(d,{of:r}),`
...
`,e.jsx(i.li,{children:"Notifications (in lavorazione): per comunicare all’utente il risultato di un’operazione o un cambiamento di stato del sistema."}),`
`,e.jsxs(i.li,{children:[e.jsx(i.a,{href:"?path=/docs/componenti-modal--documentazione",children:"Modal"}),": quando l'utente deve compiere un'azione consapevole per proseguire."]}),`
`]}),`
...
`]}),`
`,e.jsxs(i.p,{children:[e.jsx(i.a,{href:"/docs/personalizzazione-degli-stili--documentazione#selettore-part",children:"Vai alla guida sul selettore part"}),"."]})]})}function C(o={}){const{wrapper:i}={...a(),...o.components};return i?e.jsx(i,{...o,children:e.jsx(l,{...o})}):l(o)}export{C as default};
