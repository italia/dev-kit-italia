import{b as i,o as M}from"./iframe-DxWuwFk9.js";const $=["sm","lg","xl"],C=["center","left","right"],z=["alert","popconfirm","link-list"],t=e=>{const o=e.currentTarget.closest("it-modal");console.log("closeModal -> modal",o),o?.hide()},x=e=>{const o=e.currentTarget.closest("it-modal");console.log("openModal -> modal",o),o?.show()},q=e=>{const o=e.currentTarget.closest("it-modal");console.log("toggleModal -> modal",o),o?.toggle()},L={title:"Componenti/Modal",component:"it-modal",tags:["alpha","a11y-ok","web-component"],parameters:{layout:"fullscreen",docs:{story:{inline:!1,iframeHeight:420}}},args:{"modal-title":"Titolo modale","modal-description":"Descrizione della modale","custom-header":!1,size:"",position:void 0,scrollable:!1,"static-backdrop":!1,"hide-close-button":!1,"close-button-placement":"header",variant:"","close-label":"Chiudi finestra modale","disable-animation":!1,"footer-shadow":!1,triggerLabel:"Apri modale",bodyContent:"Contenuto della modale. Può includere testo, form, o qualsiasi altro elemento."},argTypes:{"modal-title":{control:"text",description:"Titolo della modale (usa slot `header` per contenuto custom)"},"modal-description":{control:"text",description:"Descrizione della modale (usa slot `description` per contenuto custom), verrrà inserita in un elemento visivamente nascosto per i lettori di schermo."},"custom-header":{control:"boolean",description:"Abilita header custom. In questo modo è possibile inserire un header personalizzato tramite slot, altrimenti lo slot header verrà inserito all'interno di un `h2` con classi predefinite per garantire la corretta semantica e accessibilità.",table:{defaultValue:{summary:"false"}}},size:{control:"select",options:$,description:"Dimensione della modale",table:{defaultValue:{summary:void 0}}},position:{control:"select",options:C,description:"Posizionamento della modale",table:{defaultValue:{summary:void 0}}},scrollable:{control:"boolean",description:"Abilita scroll interno al body",table:{defaultValue:{summary:"false"}}},"static-backdrop":{control:"boolean",description:"Disabilita chiusura su click backdrop",table:{defaultValue:{summary:"false"}}},"hide-close-button":{control:"boolean",description:"Nasconde il pulsante di chiusura"},"close-button-placement":{control:"select",options:["header","backdrop"],description:"Posizione del pulsante di chiusura: `header` (default) o `backdrop`",table:{defaultValue:{summary:"header"}}},variant:{control:"select",options:z,description:"Variante della modale",table:{defaultValue:{summary:void 0}}},"close-label":{control:"text",description:"Etichetta accessibile per il pulsante di chiusura",table:{defaultValue:{summary:"Chiudi finestra modale"}}},"disable-animation":{control:"boolean",description:"Disabilita animazione fade"},"footer-shadow":{control:"boolean",description:"Ombra sul footer per contenuti lunghi",table:{defaultValue:{summary:"false"}}},triggerLabel:{table:{disable:!0}},bodyContent:{table:{disable:!0}}}},a={name:"Esempio interattivo",tags:["!dev"],parameters:{docs:{canvas:{sourceState:"hidden"}}},render:e=>i`
  ...
  `},n={name:"Con pulsante di chiusura",render:()=>i`
  ...
  `},r={name:"Modale con footer personalizzato",render:()=>i`
  ...
  `},s={name:"Modale con elementi form",render:()=>i`
    <it-modal close-label="Chiudi finestra modale">
      <it-button variant="primary" slot="trigger">Lancia la demo della modale</it-button>
  ...
  `},u={name:"Modale con Link List",render:()=>i`
  ...
  `},c={parameters:{docs:{story:{iframeHeight:600}}},name:"Scroll di contenuti lunghi",render:()=>i`
  ...
  `},m={parameters:{docs:{story:{iframeHeight:600}}},name:"Scroll interno alla modale",render:()=>i`
  ...
  `},p={name:"Centratura verticale",render:()=>i`
  ...
  `},b={parameters:{docs:{story:{iframeHeight:600}}},name:"Allineamento a sinistra",render:()=>i`
  ...
  `},g={parameters:{docs:{story:{iframeHeight:600}}},decorators:[e=>i` <div style="display:flex; height:100%; align-items:center;">${e()}</div> `],name:"Allineamento a destra",render:()=>i`
  ...
  `},f={parameters:{docs:{story:{iframeHeight:600}}},name:"Dimensioni opzionali",render:()=>i`
  ...
  `},v={name:"Backdrop statico",render:()=>i`
  ...
  `},h={name:"Rimuovere l’animazione",render:()=>i`
  ...
  `},y={name:"Attivazione manuale via JS",decorators:[e=>i` <div style="display:flex; height:100%; align-items:center; gap:2rem;">${e()}</div> `],parameters:{docs:{source:{excludeDecorators:!0,code:`
        <it-modal disable-animation close-label="Chiudi finestra modale">
