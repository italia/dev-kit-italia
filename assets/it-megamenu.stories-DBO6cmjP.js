...
`,r=(e,t=1)=>{const v=[];for(let s=t;s<t+e;s+=1)v.push(a`
    ...
    `);return v.map(s=>a`${s}`)},b=e=>a`${i(e,a` <!-- SLOT DESCRIPTION -->
      ...
      `)},u={...n,name:"Con link “Esplora tutti”",args:{columns:3,"footer-align":"right"},render:e=>o(e,a`
        <li class="nav-item">
          ${i(e,a`
              <!-- DROPDOWN LINKS ITEMS -->
              ${r(9)}
      ...
      `)},p={...n,name:"Con call to action in basso",args:{columns:3,"footer-position":"bottom","footer-align":""},render:e=>o(e,a`
        <li class="nav-item">
          ${i(e,a`
              <!-- DROPDOWN LINKS ITEMS -->
              ${r(9)}
  ...
  render: args => renderNav(args, html\`
      ...
      \`)
}`,...g.parameters?.docs?.source}}};const S=["Base","MegamenuCompleto","MegamenuBase","MegamenuEsploraSezione","MegamenuEsploraTutti","MegamenuCTABottom","MegamenuCTARight"],M=Object.freeze(Object.defineProperty({__proto__:null,Base:l,MegamenuBase:c,MegamenuCTABottom:p,MegamenuCTARight:g,MegamenuCompleto:m,MegamenuEsploraSezione:d,MegamenuEsploraTutti:u,__namedExportsOrder:S,default:n},Symbol.toStringTag,{value:"Module"}));export{l as B,m as M,M as S,c as a,d as b,u as c,p as d,g as e};
