import{b as o,o as i}from"./iframe-BIx49rSp.js";import{S as F}from"./formControlReusableStories-uYezQGFS.js";const U=["h2","h3","h4","h5","h6"],D={$code:"it",$name:"Italiano",$dir:"ltr",upload_label:"Carica file",upload_file_list_label:"File caricati",upload_remove_loading:"Annulla caricamento file {name}",upload_remove_done:"Rimuovi file {name}",upload_remove_error:"Riprova caricamento file {name}",upload_status_loading:"Caricamento file:",upload_status_success:"File caricato:",upload_status_error:"Errore caricamento file:",upload_gallery_label:"Carica foto",upload_avatar_label:"Aggiorna foto dell'avatar",upload_avatar_overlay_label:"Aggiorna",upload_dd_title:"Trascina il file per caricarlo",upload_dd_description:"oppure selezionalo dal dispositivo",upload_dd_select:"selezionalo dal dispositivo",upload_dd_progress_label:"Avanzamento caricamento",upload_dd_status_dragover:"File pronto per il rilascio",upload_dd_status_loading:"Caricamento in corso...",upload_dd_status_success:"Caricamento completato",validityRequired:"Seleziona almeno un file."},g=["https://picsum.photos/seed/upload1/128/128","https://picsum.photos/seed/upload2/128/128","https://picsum.photos/seed/upload3/128/128","https://picsum.photos/seed/upload4/128/128"];class I extends HTMLElement{connectedCallback(){setTimeout(async()=>{const e=this.querySelector("it-upload");if(!e)return;await e.updateComplete;const t=e.addFile(new File(["x".repeat(71303168)],"nome-file-01.jpg",{type:"image/jpeg"})),v=e.addFile(new File(["x".repeat(9437184)],"nome-file-02-nome-file-lungo-per-ellissi.jpg",{type:"image/jpeg"})),x=e.addFile(new File(["x".repeat(3145728)],"nome-file-03.jpg",{type:"image/jpeg"})),E=e.addFile(new File(["x".repeat(2097152)],"nome-file-04.jpg",{type:"image/jpeg"}));e.setFileStatus(t,"success"),e.setFileStatus(v,"success"),e.setFileStatus(x,"loading",43),e.setFileStatus(E,"error"),e.setFileThumbnail(t,g[0]),e.setFileThumbnail(v,g[1]),e.setFileThumbnail(x,g[2]),e.setFileThumbnail(E,g[3])},0)}}customElements.get("story-upload-file-states")||customElements.define("story-upload-file-states",I);class T extends HTMLElement{connectedCallback(){setTimeout(async()=>{const e=this.querySelector("it-upload-drag-drop");e&&(e._fileName="nome_file.pdf",e._fileWeight="3.7 MB",e._fileType="PDF",e.start())},0)}}customElements.get("story-upload-dd-loading")||customElements.define("story-upload-dd-loading",T);class _ extends HTMLElement{connectedCallback(){setTimeout(async()=>{const e=this.querySelector("it-upload-drag-drop");e&&(e._fileName="nome_file.pdf",e._fileWeight="3.7 MB",e._fileType="PDF",e.start(),e.progress(1),e.success())},0)}}customElements.get("story-upload-dd-success")||customElements.define("story-upload-dd-success",_);class q extends HTMLElement{connectedCallback(){const e=document.createElement("button");e.type="button",e.textContent="Simula Upload",e.className="btn btn-primary mb-3",e.addEventListener("click",()=>this._simulate()),this.prepend(e),this.addEventListener("it-dd-drop",t=>{t.preventDefault(),this._simulate()})}disconnectedCallback(){clearInterval(this._timer)}_simulate(){const e=this.querySelector("it-upload-drag-drop");if(!e)return;clearInterval(this._timer),e.reset(),e._fileName="nome_file.pdf",e._fileWeight="3.7 MB",e._fileType="PDF",e.start();let t=0;this._timer=setInterval(()=>{t=Math.min(1,t+.1),e.progress(t),t>=1&&(clearInterval(this._timer),setTimeout(()=>e.success(),500))},300)}}customElements.get("story-upload-dd-interactive")||customElements.define("story-upload-dd-interactive",q);class w extends HTMLElement{connectedCallback(){setTimeout(async()=>{const e=this.querySelector("it-upload");if(!e)return;await e.updateComplete;const t=e.addFile(new File(["x"],"foto-01.jpg",{type:"image/jpeg"})),v=e.addFile(new File(["x"],"foto-02.jpg",{type:"image/jpeg"}));e.setFileThumbnail(t,g[0]),e.setFileThumbnail(v,g[1]),e.setFileStatus(t,"success"),e.setFileStatus(v,"success")},0)}}customElements.get("story-upload-gallery-prefilled")||customElements.define("story-upload-gallery-prefilled",w);const z=a=>o`
  <it-upload
    ...
    ?custom-validation="${a["custom-validation"]}"
    validity-message="${i(a["validity-message"]||void 0)}"
  >
...
`,A=a=>o`
  <it-upload-drag-drop
    ...
    heading-level="${i(a["heading-level"]||void 0)}"
    ?disabled="${a.disabled}"
    ?required="${a.required}"
    ?custom-validation="${a["custom-validation"]}"
    validity-message="${i(a["validity-message"]||void 0)}"
  ></it-upload-drag-drop>
`,L={title:"Componenti/Form/Upload",tags:["a11y-ok","web-component"],component:"it-upload",parameters:{docs:{description:{component:`
...
`}}}},f={name:"Esempio interattivo",tags:["!autodocs","!dev"],args:{variant:"default",multiple:!1,"image-preview":!1,accept:"","support-text":"",disabled:!1,required:!1,"auto-success":!0,"custom-validation":!1,"validity-message":""},argTypes:{variant:{description:"Layout del componente.",control:{type:"select"},options:["default","gallery"],table:{defaultValue:{summary:"default"}}},multiple:{description:"Consente la selezione multipla di file.",control:"boolean",table:{defaultValue:{summary:"false"}}},"image-preview":{description:"Mostra un'anteprima thumbnail per le immagini caricate.",control:"boolean",table:{defaultValue:{summary:"false"}}},accept:{description:'Tipi di file accettati, es. "image/*,.pdf".',control:"text"},"support-text":{description:"Testo di supporto visualizzato sotto il pulsante.",control:"text"},disabled:{description:"Disabilita il componente.",control:"boolean",table:{defaultValue:{summary:"false"}}},required:{description:"Rende il campo obbligatorio nella validazione del form.",control:"boolean",table:{defaultValue:{summary:"false"}}},"auto-success":{description:"I file passano automaticamente allo stato success appena selezionati.",control:"boolean",table:{defaultValue:{summary:"false"}}},"custom-validation":{description:"Attiva la validazione personalizzata. Se abilitato, disabilita la validazione nativa del browser.",control:"boolean",table:{defaultValue:{summary:"false"}}},"validity-message":{description:"Messaggio di validazione personalizzato da mostrare quando custom-validation è attivo.",control:"text"}},parameters:{docs:{canvas:{sourceState:"closed"}}},render:a=>z(a)},y={name:"Esempio interattivo Avatar",tags:["!autodocs","!dev"],args:{src:"https://randomuser.me/api/portraits/men/21.jpg",alt:"Mario Rossi",size:"xxl",disabled:!1,required:!1,"custom-validation":!1,"validity-message":""},argTypes:{src:{description:"URL dell'immagine avatar corrente.",control:"text"},alt:{description:"Testo alternativo per l'immagine.",control:"text"},size:{description:"Dimensione del componente.",control:{type:"select"},options:["xl","xxl"],table:{defaultValue:{summary:"xxl"}}},disabled:{description:"Disabilita il componente.",control:"boolean",table:{defaultValue:{summary:"false"}}},required:{description:"Rende il campo obbligatorio nella validazione del form. Se src è già valorizzato, il requisito è soddisfatto.",control:"boolean",table:{defaultValue:{summary:"false"}}},"custom-validation":{description:"Attiva la validazione personalizzata. Se abilitato, disabilita la validazione nativa del browser.",control:"boolean",table:{defaultValue:{summary:"false"}}},"validity-message":{description:"Messaggio di validazione personalizzato da mostrare quando custom-validation è attivo.",control:"text"}},parameters:{docs:{canvas:{sourceState:"closed"}}},render:a=>S(a)},b={name:"Esempio interattivo Drag & Drop",tags:["!autodocs","!dev"],args:{accept:"",illustration:"",disabled:!1,required:!1,"heading-level":"h3","custom-validation":!1,"validity-message":""},argTypes:{accept:{description:'Tipi di file accettati, es. "image/*,.pdf".',control:"text"},illustration:{description:"URL illustrazione personalizzata. Se omesso viene usata quella predefinita.",control:"text"},"heading-level":{description:"Livello del titolo semantico nella gerarchia della pagina. La dimensione visiva rimane h5.",control:{type:"select"},options:U,table:{defaultValue:{summary:"h5"}}},disabled:{description:"Disabilita il componente.",control:"boolean",table:{defaultValue:{summary:"false"}}},required:{description:"Rende il campo obbligatorio nella validazione del form.",control:"boolean",table:{defaultValue:{summary:"false"}}},"custom-validation":{description:"Attiva la validazione personalizzata. Se abilitato, disabilita la validazione nativa del browser.",control:"boolean",table:{defaultValue:{summary:"false"}}},"validity-message":{description:"Messaggio di validazione personalizzato da mostrare quando custom-validation è attivo.",control:"text"}},parameters:{docs:{canvas:{sourceState:"closed"}}},render:a=>A(a)},l={name:"Upload con lista di file",parameters:{docs:{description:{story:"Upload base che mostra i file caricati in una lista verticale con icone sostituite da thumbnail (image-preview)."},source:{language:"html",code:`
...
<\/script>
  ...
  `},s={name:"Upload con lista di file - stati",parameters:{docs:{description:{story:"Esempio con file pre-caricati in tutti gli stati supportati: `success` (caricato), `loading` al 43% di avanzamento, `error` (fallito), e `loading` a 0% (avvio). I file in stato `success` mostrano un'icona di conferma e un pulsante X separato: l'utente può rimuoverli anche dopo il caricamento, senza dover ricaricare il form."},source:{language:"html",code:`
...
<\/script>
  ...
  `},r={parameters:{docs:{description:{story:'Con `variant="gallery"` le foto caricate vengono visualizzate in una griglia a "pictures wall", ideale per gestire upload multipli di immagini.'},source:{language:"html",code:`
...
con possibilità di rimozione singola. Supporta i seguenti stati: loading, success, error.`,...l.parameters?.docs?.description}}};s.parameters={...s.parameters,docs:{...s.parameters?.docs,source:{originalSource:`{
...
<\/script>
  ...
  \`
}`,...s.parameters?.docs?.source},description:{story:"Mostra la lista file con esempi di tutti gli stati: loading (con progresso), success ed error.",...s.parameters?.docs?.description}}};r.parameters={...r.parameters,docs:{...r.parameters?.docs,source:{originalSource:`{
  parameters: {
    docs: {
      description: {
...
<\/script>
  ...
  \`
}`,...r.parameters?.docs?.source},description:{story:'Upload Gallery — visualizza le foto in una griglia a "pictures wall"',...r.parameters?.docs?.description}}};d.parameters={...d.parameters,docs:{...d.parameters?.docs,source:{originalSource:`{
...
}`,...h.parameters?.docs?.source}}};const M=["EsempioInterattivoUpload","EsempioInterattivoAvatar","EsempioInterattivoDragDrop","UploadConListaDiFile","UploadConStatoFile","UploadGallery","UploadConAvatar","UploadDragDrop","UploadFormIntegrazione","MetodiEPropUpload","MetodiEPropAvatar","MetodiEPropDragDrop","I18n"],P=Object.freeze(Object.defineProperty({__proto__:null,EsempioInterattivoAvatar:y,EsempioInterattivoDragDrop:b,EsempioInterattivoUpload:f,I18n:h,MetodiEPropAvatar:u,MetodiEPropDragDrop:m,MetodiEPropUpload:c,UploadConAvatar:d,UploadConListaDiFile:l,UploadConStatoFile:s,UploadDragDrop:n,UploadFormIntegrazione:p,UploadGallery:r,__namedExportsOrder:M,default:L},Symbol.toStringTag,{value:"Module"}));export{f as E,h as I,c as M,P as S,s as U,r as a,y as b,d as c,b as d,n as e,p as f,u as g,m as h};
