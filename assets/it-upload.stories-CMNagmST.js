...
`,U=a=>o`
  <it-upload-drag-drop
    ...
    ?required="${a.required}"
  ></it-upload-drag-drop>
`,q={title:"Componenti/Form/Upload",tags:["new","a11y-ok","web-component"],component:"it-upload",parameters:{docs:{description:{component:`
