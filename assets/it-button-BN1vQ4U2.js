import{j as e,M as d,C as n,a as p,D as s}from"./blocks-BwN-HPQk.js";import{useMDXComponents as c}from"./index-BLyyUXyz.js";import{S as u,E as t,V as h,a as x,D as j,T as m,b as a,C as l,c as b}from"./it-button.stories-Dezj7Zob.js";import"./preload-helper-PPVm8Dsz.js";import"./iframe-B_tBykbp.js";function r(o){const i={a:"a",code:"code",h1:"h1",h2:"h2",h3:"h3",h4:"h4",li:"li",p:"p",strong:"strong",ul:"ul",...c(),...o.components};return e.jsxs(e.Fragment,{children:[e.jsx(d,{of:u}),`
...
`]}),`
`,e.jsxs(i.li,{children:[`
`,e.jsxs(i.p,{children:["Quando si utilizza l'attributo ",e.jsx(i.code,{children:"disabled"})," è consigliato usare anche l'attributo ",e.jsx(i.code,{children:"it-aria-describedby"})," (o un elemento all'interno di ",e.jsx(i.code,{children:"<it-button>"})," con classe ",e.jsx(i.code,{children:".sr-only"}),") per informare tramite gli screen-reader il motivo per il quale il pulsante è disabilitato."]}),`
`]}),`
`]}),`
...
`,e.jsxs(i.p,{children:["Gli stili per il pulsante con icona vengono applicati automaticamente quando nel light DOM è presente un elemento ",e.jsx(i.code,{children:"<it-icon>"}),"."]}),`
...
`,e.jsxs(i.p,{children:["Per la personalizzazione degli stili puoi usare il selettore ",e.jsx(i.code,{children:"::part"})," passando il valore ",e.jsx(i.code,{children:"button"}),"."]}),`
`,e.jsx(i.p,{children:e.jsx(i.a,{href:"/docs/personalizzazione-degli-stili--documentazione#selettore-part",children:"Vai alla guida sul selettore part"})})]})}function D(o={}){const{wrapper:i}={...c(),...o.components};return i?e.jsx(i,{...o,children:e.jsx(r,{...o})}):r(o)}export{D as default};
