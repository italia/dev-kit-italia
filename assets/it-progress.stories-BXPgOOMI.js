import{o,b as r}from"./iframe-CPP02t7X.js";const a=e=>e.type==="donut"?r`
      <it-progress
        type="donut"
        value="${e.value}"
        it-aria-label="${o(e["it-aria-label"]||void 0)}"
        color="${o(e.color||void 0)}"
      ></it-progress>
    `:e.type==="spinner"?r`
      <it-progress
        type="spinner"
    ...
    <it-progress
      ...
      label="${o(e.label||void 0)}"
      ?indeterminate="${e.indeterminate}"
      color="${o(e.color!=="default"?e.color:void 0)}"
    ></it-progress>
  `,g={title:"Componenti/Progress",tags:["a11y-ok","web-component"],component:"it-progress",args:{type:"bar",value:50,"it-aria-label":"Caricamento",showValue:!1,label:"",indeterminate:!1,color:"default",active:!0,double:!1,size:"md"},argTypes:{type:{control:"select",options:["bar","donut","spinner"],description:"Tipologia di progress indicator",table:{defaultValue:{summary:"bar"}}},value:{control:{type:"range",min:0,max:100,step:1},description:"Percentuale di avanzamento (da 0 a 100)",table:{defaultValue:{summary:"50"}}},showValue:{name:"show-value",control:"boolean",description:'mostra la percentuale di avanzamento <br/><i>(solo per `type="bar"`)</i>',table:{defaultValue:{summary:"false"}}},"it-aria-label":{control:"text",description:"Etichetta accessibile per gli screen reader (aria-label)",table:{defaultValue:{summary:"Caricamento"}}},label:{name:"label",control:"text",description:'se si vuole mostrare un testo personalizzato per l\'etichetta, invece della percentuale di avanzamento <br/><i>(solo per `type="bar"`)</i>'},indeterminate:{control:"boolean",description:'stato indeterminato (animazione infinita) <br/><i>(solo per `type="bar"`)</i>',table:{defaultValue:{summary:"false"}}},color:{control:"select",options:["default","success","info","warning","danger","#ff0000"],description:'<strong>Bar:</strong> default|success|info|warning|danger. <br/><br/><strong>Donut:</strong> default|success|info|warning|danger, oppure un qualsiasi colore CSS (es. `#ff0000`)<br/><br/><i>(solo per `type="bar"` e `type="donut"`)</i>',table:{defaultValue:{summary:"default"}}},active:{control:"boolean",description:'attiva/disattiva l\'animazione <br/><i>(solo per `type="spinner"`)</i>',table:{defaultValue:{summary:"true"}}},double:{control:"boolean",description:'variante doppia <br/><i>(solo per `type="spinner"`)</i>',table:{defaultValue:{summary:"false"}}},size:{control:"select",options:["sm","md","lg","xl"],description:'dimensione <br/><i>(solo per `type="spinner"`)</i>',table:{defaultValue:{summary:"md"}}}},parameters:{pageLayout:"w-100"}},s={name:"Esempio interattivo",tags:["!dev"],args:{type:"bar",value:50,color:"default",showValue:!1,label:"",indeterminate:!1},parameters:{docs:{canvas:{sourceState:"shown"}}},render:a},i={args:{type:"bar",value:50},parameters:{controls:{exclude:["active","double","size"]}},render:a},n={name:"Bar con etichetta",args:{type:"bar",value:35,showValue:!0,label:"35%"},render:e=>r`
  ...
  `},u={name:"Donut: varianti di colore",parameters:{pageLayout:"center"},render:()=>r`
    <div class="row">
      ${["default","success","info","warning","danger"].map(e=>r`
          <div class="col-auto px-4">
            <div class="text-center mb-3">${e}</div>
            <it-progress type="donut" value="75" color="${e}" it-aria-label="Caricamento - ${e}"></it-progress>
          </div>
        `)}
    </div>
  `},b=(e,t)=>r`
...
`,m={args:{type:"spinner",active:!0,double:!1,size:"md"},parameters:{controls:{exclude:["show-value","label","indeterminate"]}},render:e=>b(e,"Spinner")},v={name:"Spinner doppio",args:{type:"spinner",active:!0,double:!0,size:"md"},render:e=>b(e,"Spinner doppio")};s.parameters={...s.parameters,docs:{...s.parameters?.docs,source:{originalSource:`{
  ...
  render: () => html\`
    <div class="row">
      \${['default', 'success', 'info', 'warning', 'danger'].map(color => html\`
          <div class="col-auto px-4">
...
}`,...v.parameters?.docs?.source}}};const y=["EsempioInterattivo","Bar","ConEtichetta","Indeterminato","Colori","Button","Donut","ColoriDonut","Spinner","SpinnerDoppio"],$=Object.freeze(Object.defineProperty({__proto__:null,Bar:i,Button:p,Colori:c,ColoriDonut:u,ConEtichetta:n,Donut:d,EsempioInterattivo:s,Indeterminato:l,Spinner:m,SpinnerDoppio:v,__namedExportsOrder:y,default:g},Symbol.toStringTag,{value:"Module"}));export{p as B,n as C,d as D,s as E,l as I,$ as P,m as S,c as a,u as b,v as c};
