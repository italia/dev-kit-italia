import{b as r}from"./iframe-DswZOSx7.js";const l={title:"Componenti/Alert",tags:["new","a11y-ok","documentation"],parameters:{layout:"padded"}},e={decorators:[n=>r`<div style="display:flex;flex-direction:column;gap:1rem">${n()}</div>`],render:()=>r`
