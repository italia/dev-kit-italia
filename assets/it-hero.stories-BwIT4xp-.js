import{b as a,o as g}from"./iframe-Cl3Kz-XE.js";const h=[void 0,"primary","filter"],n={title:"Componenti/Hero",tags:["web-component","a11y-ok"],component:"it-hero",parameters:{pageLayout:"w-100"},args:{"it-aria-label":void 0,center:!1,"overlay-color":void 0,overlap:!1},argTypes:{"it-aria-label":{control:"text",description:"Testo usato come `aria-label` sul contenitore dell'Hero (es. \"In evidenza\"). Obbligatorio quando l'hero contiene solamente un'immagine."},center:{control:"boolean",description:"Allinea al centro il testo dello slot `text`.",table:{defaultValue:{summary:"false"}}},"overlay-color":{control:"select",options:h,description:"Imposta il colore di overlay",type:"string"},overlap:{control:"boolean",description:"Sovrappone l'elemento che segue al componente Hero.",table:{defaultValue:{summary:"false"}}}}},p=a` <img
