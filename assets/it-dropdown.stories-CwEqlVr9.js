import{b as i,o as t}from"./iframe-DswZOSx7.js";const r="height:200px;display:flex;align-items:flex-start;",z={title:"Componenti/Dropdown",component:"it-dropdown",tags:["a11y-ok","web-component"],args:{label:"Apri dropdown",disabled:!1,alignment:void 0,variant:"primary",size:void 0,"it-role":void 0,dark:!1,"full-width":!1,"it-aria-label":void 0},argTypes:{label:{control:"text",description:"Testo del pulsante che apre il dropdown"},disabled:{control:"boolean",description:"Disabilita il dropdown",table:{defaultValue:{summary:"false"}}},alignment:{control:"select",description:"Posizionamento del menu rispetto al pulsante",options:["top","right","bottom","left","top-start","top-end","right-start","right-end","bottom-start","bottom-end","left-start","left-end"],type:"string",table:{defaultValue:{summary:"bottom-start"}}},variant:{control:"select",description:"Variante grafica del pulsante",options:["primary","secondary","success","danger","warning","light","link"],type:"string",table:{defaultValue:{summary:"primary"}}},size:{control:"select",description:"Dimensione del pulsante",options:["sm","lg"],type:"string",table:{}},dark:{control:"boolean",description:"Stile scuro per il menu dropdown",table:{defaultValue:{summary:"false"}}},"full-width":{control:"boolean",description:"Imposta la larghezza del menu dropdown al 100% del contenitore",table:{defaultValue:{summary:"false"}}},"it-aria-label":{control:"text",description:"Valore per l'attributo `aria-label` del pulsante (obbligatorio per accessibilità se `label` è vuoto)",type:"string"}}};function e(o){return Object.keys(z.argTypes).reduce((u,b)=>(o?.includes(b)||(u[b]={table:{disable:!0}}),u),{})}const n={render:o=>i`
  ...
  `,decorators:[o=>i`<div style="display:grid;gap:.5rem;grid:1fr 1fr 1fr/1fr 1fr 1fr;">${o()}</div>`],argTypes:{...e()}},p={render:o=>i`
  ...
  `,argTypes:{...e(["label","variant"])},decorators:[o=>i`<div style=${r}>${o()}</div>`]},l={args:{disabled:!0},render:o=>i`
  ...
  `,argTypes:{...e(["label","variant"])},decorators:[o=>i`<div style=${r}>${o()}</div>`]},g={args:{dark:!0},render:o=>i`
...
}`,...g.parameters?.docs?.source}}};const v=["Base","Varianti","Posizionamento","MenuVociAttive","MenuDisabilitato","MenuVociDisabilitate","MenuIntestazioniSeparatori","MenuVociGrandi","MenuATuttaLarghezza","MenuIconaDestra","MenuIconaSinistra","MenuScuro"],y=Object.freeze(Object.defineProperty({__proto__:null,Base:n,MenuATuttaLarghezza:c,MenuDisabilitato:l,MenuIconaDestra:f,MenuIconaSinistra:h,MenuIntestazioniSeparatori:m,MenuScuro:g,MenuVociAttive:p,MenuVociDisabilitate:s,MenuVociGrandi:w,Posizionamento:a,Varianti:d,__namedExportsOrder:v,default:z},Symbol.toStringTag,{value:"Module"}));export{n as B,l as M,a as P,y as S,d as V,p as a,s as b,m as c,w as d,c as e,f,h as g,g as h};
