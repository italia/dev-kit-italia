import{j as e,M as s,T as d,C as n,a as c}from"./blocks-Bgvhxh8a.js";import{useMDXComponents as r}from"./index-B7LUDehp.js";import{S as o,E as a,M as p,F as u,C as m,a as h,b as x,P as j,c as g,d as v,e as z,A as f,f as b,D as I,g as A,B as w,h as P}from"./it-modal.stories-BZDVvjBX.js";import"./preload-helper-PPVm8Dsz.js";import"./iframe-DswZOSx7.js";function t(l){const i={a:"a",code:"code",h2:"h2",h3:"h3",li:"li",p:"p",pre:"pre",strong:"strong",ul:"ul",...r(),...l.components};return e.jsxs(e.Fragment,{children:[e.jsx(s,{of:o}),`
`,e.jsx(d,{of:o}),`
...
`,e.jsx(i.li,{children:"Tooltip e popover (in lavorazione): per spiegare una funzione specifica o fornire informazioni aggiuntive, sono meno invasive di una finestra modale e si possono attivare in diversi modi."}),`
`]}),`
...
`]}),`
`,e.jsxs(i.p,{children:[e.jsx(i.a,{href:"/docs/personalizzazione-degli-stili--documentazione#selettore-part",children:"Vai alla guida sul selettore part"}),"."]})]})}function R(l={}){const{wrapper:i}={...r(),...l.components};return i?e.jsx(i,{...l,children:e.jsx(t,{...l})}):t(l)}export{R as default};
