import{j as e,M as o}from"./blocks-B2Z53WGn.js";import{useMDXComponents as l}from"./index-BcnZ8Wn6.js";import"./preload-helper-PPVm8Dsz.js";import"./iframe-Ts_oPF3y.js";var s={GH_PAGES_PATH:"https://design-web-components.vercel.app"};const r=s.GH_PAGES_PATH+"/next-app/";function t(i){const n={a:"a",code:"code",h1:"h1",h2:"h2",li:"li",p:"p",pre:"pre",strong:"strong",ul:"ul",...l(),...i.components};return e.jsxs(e.Fragment,{children:[e.jsx(o,{title:"Framework/SSR"}),`
`,`
...
`})}),`
`,e.jsx(n.h2,{id:"altri-framework-ssr-nuxt-angular-universal-remix-",children:"Altri framework SSR (Nuxt, Angular Universal, Remix, ...)"}),`
`,e.jsxs(n.p,{children:["Il principio è lo stesso ovunque: registra i componenti in un hook lato client (",e.jsx(n.code,{children:"onMounted"})," in Nuxt, un guard su ",e.jsx(n.code,{children:"isPlatformBrowser"})," o ",e.jsx(n.code,{children:"afterNextRender"})," in Angular Universal, ",e.jsx(n.code,{children:"useEffect"}),"/",e.jsx(n.code,{children:"ClientOnly"})," in Remix), e mantieni il markup con gli slot statico nel template così che il server lo emetta comunque."]}),`
