import{o as s,A as l,b as m}from"./iframe-DCBfcb_A.js";function u({stackable:r,paddingTop:c,stickyClassName:d,positionType:p}){return m`
    <it-sticky
      ?stackable=${s(r)}
      padding-top=${s(c||l)}
...
}`,...n.parameters?.docs?.source}}};const g=["Base","TopOffset","Fixed","CustomClass","Stackable","CustomEvents"],b=Object.freeze(Object.defineProperty({__proto__:null,Base:e,CustomClass:a,CustomEvents:n,Fixed:t,Stackable:o,TopOffset:i,__namedExportsOrder:g,default:y},Symbol.toStringTag,{value:"Module"}));export{b as S};
