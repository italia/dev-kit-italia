import{b as e,o as b}from"./iframe-Cl3Kz-XE.js";const z=["nozoom","black","primary"],$=["bottom","top","left","right"],S=[2,3,4,5],O=[{src:"https://picsum.photos/240/160?image=1056",alt:"Visualizza immagine 1"},{src:"https://picsum.photos/240/160?image=1050",alt:"Visualizza immagine 2"},{src:"https://picsum.photos/240/160?image=1044",alt:"Visualizza immagine 3"},{src:"https://picsum.photos/240/160?image=1039",alt:"Visualizza immagine 4"},{src:"https://picsum.photos/240/160?image=1029",alt:"Visualizza immagine 5"}],a=(t=3,g=!0)=>O.slice(0,t).map((y,f)=>e`
      <it-thumbnav-item ?active="${f===0&&g}">
...
\`\`\`
        `}}}},r={name:"Esempio interattivo",tags:["!dev"],parameters:{docs:{canvas:{sourceState:"hidden"}}},render:t=>V(t)},i={name:"Versione small",render:()=>e` <it-thumbnav small> ${a(3)} </it-thumbnav> `},o={name:"Hover senza zoom",render:()=>e` <it-thumbnav hover="nozoom"> ${a(3)} </it-thumbnav> `},s={name:"Hover con layer nero",render:()=>e` <it-thumbnav hover="black"> ${a(3)} </it-thumbnav> `},n={name:"Hover con layer primary",render:()=>e` <it-thumbnav hover="primary"> ${a(3)} </it-thumbnav> `},m={name:"Thumbnav verticale",render:()=>e` <it-thumbnav vertical> ${a(3)} </it-thumbnav> `},l={name:"Overlay orizzontale inferiore",parameters:{layout:"fullscreen"},render:()=>e`
    <div class="position-relative" style="height: 400px;">
      ...
      />
      <it-thumbnav position="bottom" small> ${a(3)} </it-thumbnav>
    </div>
  `},c={name:"Overlay orizzontale superiore",parameters:{layout:"fullscreen"},render:()=>e`
    <div class="position-relative" style="height: 400px;">
      <img
        ...
        style="width:100%;height:100%;object-fit:cover;"
      />
      <it-thumbnav position="top" small> ${a(3)} </it-thumbnav>
    </div>
  `},p={name:"Overlay verticale a sinistra",parameters:{layout:"fullscreen"},render:()=>e`
    <div class="position-relative" style="height: 500px;">
      <img
        ...
        style="width:100%;height:100%;object-fit:cover;"
      />
      <it-thumbnav position="left" small> ${a(3)} </it-thumbnav>
    </div>
  `},u={name:"Overlay verticale a destra",parameters:{layout:"fullscreen"},render:()=>e`
    <div class="position-relative" style="height: 500px;">
      <img
        ...
        style="width:100%;height:100%;object-fit:cover;"
      />
      <it-thumbnav position="right" small> ${a(3)} </it-thumbnav>
    </div>
  `},h={name:"Griglia a larghezza fissa",parameters:{pageLayout:"w-100"},render:()=>e` <it-thumbnav fixed> ${a(5)} </it-thumbnav> `},v={name:"Griglia automatica - 3 per riga",parameters:{pageLayout:"w-100"},render:()=>e` <it-thumbnav auto="3"> ${a(5)} </it-thumbnav> `},d={name:"Griglia automatica - 5 per riga",parameters:{pageLayout:"w-100"},render:()=>e` <it-thumbnav auto="5"> ${a(5)} </it-thumbnav> `};r.parameters={...r.parameters,docs:{...r.parameters?.docs,source:{originalSource:`{
