import{b as r,o as S,A as C}from"./iframe-CGo9iNzD.js";const b={$code:"it",$name:"Italiano",$dir:"ltr",carousel_prev:"Slide precedente",carousel_next:"Slide successiva",carousel_first:"Vai alla prima slide",carousel_last:"Vai all'ultima slide",carousel_slideX:"Vai alla slide %s",carousel_pageX:"Vai a pagina %s",carousel_play:"Attiva autoplay",carousel_pause:"Pausa autoplay",carousel_carousel:"carosello",carousel_select:"Seleziona una slide da mostrare",carousel_slide:"slide",carousel_slideLabel:"%s di %s",carousel_startautoplay:"Attiva autoplay",carousel_stopautoplay:"Spegni autoplay"},w=["single","columns","gallery-sm","gallery-lg"],z=(e,t,h)=>r` <it-card full-height="">
    ...
    </it-carousel-slide>`:t?.type==="cardWithImage"?r`<it-carousel-slide>${z(!0,void 0,e)}</it-carousel-slide>`:r`<it-carousel-slide>${z(!1,void 0,e)}</it-carousel-slide>`,a=e=>r`
  <it-carousel
    variant=${e.variant}
