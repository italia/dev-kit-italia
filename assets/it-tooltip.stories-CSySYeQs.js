import{b as e,o as m}from"./iframe-Ts_oPF3y.js";const b=["top","top-start","top-end","right","right-start","right-end","bottom","bottom-start","bottom-end","left","left-start","left-end"],d={title:"Componenti/Tooltip",component:"it-tooltip",tags:["alpha","web-component","a11y-ok"],parameters:{layout:"padded"},args:{placement:"top"},argTypes:{placement:{control:"select",options:b,description:"Posizione del Tooltip rispetto al suo elemento trigger",table:{defaultValue:{summary:"top"}}}}};function u(t){return Object.keys(d.argTypes).reduce((o,n)=>(o[n]={table:{disable:!0}},o),{})}const r={decorators:[t=>e`<div style="padding:30px 0;text-align:center">${t()}</div>`],render:t=>e`
