import{_ as t}from"./iframe-BJMmF07V.js";import{i as g,E as A,b as R,x as L,a as I}from"./lit-element-DvQWNfDj.js";import{n as l,t as O}from"./property-DPMN11qy.js";import{r as T,e as D}from"./query-Dd0DvlgZ.js";function m(o,r,i,e){var a=arguments.length,u=a<3?r:e,n;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")u=Reflect.decorate(o,r,i,e);else for(var s=o.length-1;s>=0;s--)(n=o[s])&&(u=(a<3?n(u):a>3?n(r,i,u):n(r,i))||u);return a>3&&u&&Object.defineProperty(r,i,u),u}function p(o,r){if(typeof Reflect=="object"&&typeof Reflect.metadata=="function")return Reflect.metadata(o,r)}/**
 * @license
 *
...
.icon-white {
  fill: #fff !important;
}`;let _=class extends y{constructor(){super(...arguments),this.align="middle",this.label="",this.padded=!1}async updated(r){if(r.has("name")&&this.name){const i=k(this.name);if(i){const e=(await i()).default;this.parseAndStoreSvg(e)}}r.has("src")&&this.src&&await this.loadSvgFromUrl(this.src),r.has("label")&&this.handleTitleId(),(r.has("label")||r.has("size")||r.has("color")||r.has("padded")||r.has("role")||r.has("align"))&&this.updateSvgAttributes()}handleTitleId(){this.label?this.titleId||(this.titleId=`icon-label-${crypto.randomUUID()}`):this.titleId=void 0}async loadSvgFromUrl(r){try{const i=await fetch(r);if(!i.ok)throw new Error(`Failed to load SVG from ${r} (status: ${i.status})`);const e=await i.text();this.parseAndStoreSvg(e)}catch{this.svgElement=void 0,this.announceSvgLoadError()}}announceSvgLoadError(){this.dispatchEvent(new Event("error",{bubbles:!1,composed:!1,cancelable:!1}))}parseAndStoreSvg(r){const a=new DOMParser().parseFromString(r,"image/svg+xml").documentElement;this.svgElement=a,this.updateSvgAttributes()}applySvgAttributes(r){r.removeAttribute("width"),r.removeAttribute("height");const i=this.updateClasses();if(r.setAttribute("class",i),r.setAttribute("part","icon"),this.label){if(r.removeAttribute("aria-hidden"),r.setAttribute("role","img"),r.removeAttribute("aria-labelledby"),r.querySelectorAll("title").forEach(e=>e.remove()),this.titleId){const e=document.createElementNS("http://www.w3.org/2000/svg","title");e.id=this.titleId,e.textContent=this.label,r.prepend(e),r.setAttribute("aria-labelledby",this.titleId)}}else r.setAttribute("aria-hidden","true"),r.setAttribute("role","presentation"),r.removeAttribute("aria-labelledby"),r.querySelectorAll("title").forEach(e=>e.remove())}updateSvgAttributes(){this.svgElement&&this.applySvgAttributes(this.svgElement)}updateClasses(){return["icon",this.size?`icon-${this.size}`:"",this.color?`icon-${this.color}`:"",this.align?`align-${this.align}`:"",this.padded?"icon-padded":""].filter(Boolean).join(" ").trim()}handleSlotChange(){const i=this.slotEl.assignedNodes({flatten:!0}).find(e=>e.nodeType===Node.ELEMENT_NODE&&e.tagName.toLowerCase()==="svg");i&&this.applySvgAttributes(i)}render(){return L`
      <slot @slotchange=${this.handleSlotChange}>${this.svgElement?R`${this.svgElement}`:A}</slot>
    `}};_.styles=x;m([l({type:String,reflect:!0}),p("design:type",Object)],_.prototype,"size",void 0);m([l({type:String}),p("design:type",String)],_.prototype,"name",void 0);m([l({type:String,reflect:!0}),p("design:type",String)],_.prototype,"color",void 0);m([l({type:String,reflect:!0}),p("design:type",String)],_.prototype,"align",void 0);m([l({type:String,reflect:!0}),p("design:type",Object)],_.prototype,"label",void 0);m([l({type:Boolean,reflect:!0}),p("design:type",Object)],_.prototype,"padded",void 0);m([l({type:String,reflect:!0}),p("design:type",String)],_.prototype,"src",void 0);m([T(),p("design:type",HTMLElement)],_.prototype,"svgElement",void 0);m([D("slot"),p("design:type",HTMLSlotElement)],_.prototype,"slotEl",void 0);_=m([O("it-icon")],_);
