import{b as a}from"./iframe-Cl3Kz-XE.js";const r={breakpoint:991,openAriaLabel:"Mostra la navigazione",closeAriaLabel:"Chiudi la navigazione",modalAriaLabel:"Navigazione del sito",hideHeaderBrand:!1,modalHeaderTheme:void 0},H={title:"Componenti/Header",tags:["web-component","a11y-ok"],parameters:{pageLayout:"w-100"},argTypes:{breakpoint:{control:{type:"number"},description:"Larghezza in pixel sotto la quale si attiva la modalita mobile.",table:{defaultValue:{summary:"991"}}},openAriaLabel:{name:"open-aria-label",control:{type:"text"},description:"Etichetta ARIA del pulsante che apre la navigazione mobile.",table:{defaultValue:{summary:"Mostra la navigazione"}}},closeAriaLabel:{name:"close-aria-label",control:{type:"text"},description:"Etichetta ARIA del pulsante che chiude la navigazione mobile.",table:{defaultValue:{summary:"Chiudi la navigazione"}}},modalAriaLabel:{name:"modal-aria-label",control:{type:"text"},description:"Etichetta ARIA della modale usata per la navigazione mobile.",table:{defaultValue:{summary:"Navigazione del sito"}}},hideHeaderBrand:{name:"hide-header-brand",control:{type:"boolean"},description:"Nasconde la fascia contente il brand, nell header della modale del menu su mobile.",table:{defaultValue:{summary:"false"}}},modalHeaderTheme:{name:"modal-header-theme",control:{type:"select"},options:["dark","light"],description:"Tema del background dell'header della modale mobile. Se non valorizzato, usa il tema di default usato nell'Header Center.",table:{defaultValue:{summary:"default (auto)"}}}}},h=({accessButton:e="default",theme:g="default"}={})=>{let f=a`<it-button variant="primary" size="xs">Accedi</it-button>`;return e==="full"&&(f=a` <a
      href="#"
  ...
  </div>`},i={render:()=>h()},n={name:"Slim Header con Pulsante full-responsive",render:()=>h({accessButton:"full"})},t={name:"Slim Header - Versione chiara",render:()=>h({theme:"light"})},u=({theme:e="default",compact:g=!1}={})=>a` <div
  ...
  </div>`,o={render:()=>b()},c={name:"Header Nav - Versione chiara",render:()=>b({wrapperClassName:"theme-light"})},m={name:"Header Nav con Navigazione secondaria",render:()=>a`<div class="it-header-navbar-wrapper">
      <div class="container-xxl">
        <div class="row">
          <div class="col-12">
            <!--start nav-->
